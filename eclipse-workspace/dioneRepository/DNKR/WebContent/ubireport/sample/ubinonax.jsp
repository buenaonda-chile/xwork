...
<script type="text/javascript" src="/myapp/ubireport/nonax/ubiws.js"></script>
...
<!--
	...
	var jrfdir = "/WAS/myapp/ubireport/work/";	// 리포트 파일 서버 경로
	var jrffile = "ubi_sample.jrf";				// 리포트파일명
	var dsname = "jdbc/tutorial";				// 데이타소스명
	var args = "arg_1#val_1#...#arg_n#val_n#";	// 아규먼트 정보
