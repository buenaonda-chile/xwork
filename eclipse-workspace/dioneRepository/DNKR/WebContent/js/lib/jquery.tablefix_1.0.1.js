 ...
 */
/*
 * Arranged by Koji Yamamoto.
 * I was supported for embedding check box to leftmost column of the table.
 */
(function($){
    $.fn.tablefix = function(options) {
        return this.each(function(index){
            ...
            rowTable.find('tr').each(function(indexY) {
                var g = $(this).find('th:first,td:first');
                var h = g.find(':checkbox');
                h.attr('name', 'dummy_tablefix');
