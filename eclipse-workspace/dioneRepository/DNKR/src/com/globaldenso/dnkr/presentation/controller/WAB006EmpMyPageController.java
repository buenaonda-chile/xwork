 ...
 */
@Controller
@RequestMapping(value = "/WAB006EmpMyPage")
@ViewId(value = "WAB006")
public class WAB006EmpMyPageController {
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAB006EmpMyPageController() {
        // no process
    }
    /**
     * [KR] <br>     
    ...
    public ModelAndView init(@ModelAttribute("WAB002EmpCreateForm") WAB002EmpCreateForm form, HttpServletRequest request)  throws Exception {
        ...
        //System.out.println("WAB006EmpMyPage/init.do");
        ...
        mv.addObject("url", "WAB006EmpMyPage.jsp");
        mv.setViewName(".tiles.page.WAB006");
        return mv;
    ...
    @ErrorBack(viewName = ".tiles.page.WAB006")
...
//          if(! Strings.judgeBlank(form.getClsCode()) && form.getInOutType().equals("I")){
        ...
        mv.addObject("url", "WAB006EmpSearch.jsp");
        mv.setViewName("forward:init.do");
        return mv;
