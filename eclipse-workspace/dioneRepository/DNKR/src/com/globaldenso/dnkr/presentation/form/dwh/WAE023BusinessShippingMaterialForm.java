 ...
 * @version $Revision$
 */
public class WAE023BusinessShippingMaterialForm extends BusinessShippingMaterialDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE023BusinessShippingMaterialForm(){
        super();
    }
     ...
     */
    @Override
    public WAE023BusinessShippingMaterialForm clone() {
        WAE023BusinessShippingMaterialForm clone = new WAE023BusinessShippingMaterialForm();
        try {
