 ...
 * @version $Revision$
 */
public class WAE036DailyDepartmentCostForm extends DailyDepartmentCostDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE036DailyDepartmentCostForm(){
        super();
    }
     ...
     */
    @Override
    public WAE036DailyDepartmentCostForm clone() {
        WAE036DailyDepartmentCostForm clone = new WAE036DailyDepartmentCostForm();
        try {
