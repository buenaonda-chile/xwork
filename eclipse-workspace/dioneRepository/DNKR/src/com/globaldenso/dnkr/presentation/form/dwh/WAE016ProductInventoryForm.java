 ...
 * @version $Revision$
 */
public class WAE016ProductInventoryForm extends ProductInventoryDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE016ProductInventoryForm(){
        super();
    }
     ...
     */
    @Override
    public WAE016ProductInventoryForm clone() {
        WAE016ProductInventoryForm clone = new WAE016ProductInventoryForm();
        try {
