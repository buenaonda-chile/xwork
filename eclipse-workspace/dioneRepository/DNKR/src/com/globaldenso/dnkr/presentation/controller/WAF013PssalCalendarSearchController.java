 ...
 */
@Controller
@RequestMapping(value = "/WAF013PssalCalendarSearch")
@ViewId(value = "WAF013")
public class WAF013PssalCalendarSearchController {
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAF013PssalCalendarSearchController() {
        // no process
    }
    ...
    public ModelAndView init(HttpServletRequest request) throws Exception {
        ...
        //System.out.println("/WAF013PssalCalendarSearch");
...
//          list = psogmService.getogm313_cmbprtcd(domain);
        ...
        mv.addObject("url", "WAF013PssalCalendarSearch.jsp");
        mv.setViewName(".tiles.page.WAF013");
        return mv;
    }
