 ...
 * @version $Revision$
 */
public class WAE032WipReportForm extends WipReportDomain implements Cloneable{
     ...
     */
    @Override
    public WAE032WipReportForm clone() {
        WAE032WipReportForm clone = new WAE032WipReportForm();
        try {
