...
/**
 * [EN] The class defines the controls of Menu (WAF009).<br>
 ...
 */
@Controller
@RequestMapping(value = "/WAF009PsogmProdManage")
@ViewId(value = "WAF009")
public class WAF009PsogmProdManageController {
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAF009PsogmProdManageController() {
        // no process
    }
    ...
    public ModelAndView init(HttpServletRequest request) throws Exception {
        ...
        //System.out.println("/WAF009PsogmProdManage");
...
//          list = psogmService.getogm313_cmbprtcd(domain);
        ...
        mv.addObject("url", "WAF009PsogmProdManage.jsp");
        mv.setViewName(".tiles.page.WAF009");
        return mv;
    }
