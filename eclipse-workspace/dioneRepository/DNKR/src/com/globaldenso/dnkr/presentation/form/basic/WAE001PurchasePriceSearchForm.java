 ...
 * @version $Revision$
 */
public class WAE001PurchasePriceSearchForm extends DataWareHouseDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE001PurchasePriceSearchForm(){
        super();
    }
     ...
     */
    @Override
    public WAE001PurchasePriceSearchForm clone() {
        WAE001PurchasePriceSearchForm clone = new WAE001PurchasePriceSearchForm();
        try {
