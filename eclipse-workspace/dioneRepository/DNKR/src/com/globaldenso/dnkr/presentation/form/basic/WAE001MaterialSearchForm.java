 ...
 * @version $Revision$
 */
public class WAE001MaterialSearchForm extends DataWareHouseDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE001MaterialSearchForm(){
        super();
    }
     ...
     */
    @Override
    public WAE001MaterialSearchForm clone() {
        WAE001MaterialSearchForm clone = new WAE001MaterialSearchForm();
        try {
