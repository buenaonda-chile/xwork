@echo off
REM ****************************************************************************
REM ** [JP]  ファイル名 : aijmJobJp1Launcher.bat
...
REM ** [JP]      2 : 実行するジョブID
REM **
REM ** [EN]  File name               : aijmJobJp1Launcher.bat
...
REM **
REM **  $ aijmJp1JobLauncher.bat 1706 2015-06-12 02:40:40Z 815372040074 $
REM **
REM ****************************************************************************
...
set EXECUTE_CLASS=com.globaldenso.ai.akatsuki.aijm.job.control.JobJp1Launcher
...
javaw -Xrs -Xmx%JAVA_XMX%m -Xms%JAVA_XMS%m -XX:MetaspaceSize=%JAVA_METASIZE%m -XX:MaxMetaspaceSize=%JAVA_METASIZE%m -Dlog4j.configurationFile=%LOG_XML% %EXECUTE_CLASS% %1 %2 >> %BATCH_LOG_DIR%\%2\%seq%.log
exit /b %errorlevel%
