@echo off
REM ****************************************************************************
REM ** [JP]  ファイル名 : aijmMainControllerStart.bat                              **
REM ** [JP]  処理概要   : AijmMainController(AMC)の起動                            **
REM ** [EN]  File name             : aijmMainControllerStart.bat                   **
REM ** [EN]  Outline of processing : Start AijmMainController(AMC)                 **
REM ** ---------------------------------------------------------------------- **
...
REM **                                                                        **
REM **  $ aijmMainControllerStart.bat 1495 2015-05-11 07:56:47Z 815372040074 $
REM **                                                                        **
REM ****************************************************************************
...
echo [boot] [%DATE% %TIME%] [ERROR] setenv.bat Execute Failed >> %~dp0\aijmMainControllerStart.log

:NREND
REM [JP] ==== ログ出力先設定 ====================================
REM [EN] ==== Log output destination setting ====================================
set LOGFILE=%AIJM_DIR%\logs\aijmMainControllerStart.log

REM [JP] ==== 処理開始ログ出力 ==================================
REM [EN] ==== Log output process starts ==================================
echo %DATE% %TIME% INFO :START AijmMainController StartBatch >> %LOGFILE%
...
echo %DATE% %TIME% INFO :END AijmMainController StartBatch >> %LOGFILE%
echo -------------------------------------------------------------------------------- >> %LOGFILE%
exit
