...
//    }
    ...
    public synchronized Connection getConnection()
        ...
        if (!initialized) {
            ...
            Class c = Class.forName(GeneratorConst._DRIVER);
...
//                System.out.println("co.connection:" + co.connection);
        ...
        for (int i = 0; i < connections.size(); i++) {
            ...
            if ((i + 1) > GeneratorConst._OPENCONNECTIONS && !co.inUse)
    ...
    private Connection createConnection() throws SQLException {
        ...
        try {
            ...
            props.put("user", GeneratorConst._USER);

            props.put("password", GeneratorConst._PASSWORD);
            ...
            con = DriverManager.getConnection(GeneratorConst._URL, props);
