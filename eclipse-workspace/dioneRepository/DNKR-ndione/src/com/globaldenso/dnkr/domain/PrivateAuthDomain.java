 ...
 *
 */
public class PrivateAuthDomain implements Serializable {
    ...
    /***
     */
    private List<PrivateAuthDomain> privateAuthList;
    ...
    */
     ...
     * @return the authCode
     */
    public List<PrivateAuthDomain> getPrivateAuthList() {
        return privateAuthList;
    }
    ...
    * [JP] <br>
    * 
    * @param privateAuthList List<PrivateAuthDomain>
    */
    public void setPrivateAuthList(List<PrivateAuthDomain> privateAuthList) {
        this.privateAuthList = privateAuthList;
    }
