...
public class CodeServiceImpl implements CodeService {
     ...
     * {@inheritDoc}
     * 
     * @see com.globaldenso.dnkr.business.service.CodeService#searchByExceptionDeptCode(ExceptionCodeDomain)
     */
     public List<ExceptionCodeDomain> searchByExceptionDeptCode(ExceptionCodeDomain domain) throws ApplicationException {
         return codeDao.searchByExceptionDeptCode(domain);
     }
     
     public int searchByExceptionDeptCodeCount(ExceptionCodeDomain domain) throws ApplicationException{
         return codeDao.searchByExceptionDeptCodeCount(domain);
     }

     /**
      * {@inheritDoc}
      * 
      * @see com.globaldenso.dnkr.business.service.CodeService#createExceptionDeptCode(ExceptionCodeDomain)
      */
     public int createExceptionDeptCode(ExceptionCodeDomain domain) throws ApplicationException {
         return codeDao.createExceptionDeptCode(domain);
     }
     
     /**
      * {@inheritDoc}
      * 
      * @see com.globaldenso.dnkr.business.service.CodeService#updateExceptionDeptCode(ExceptionCodeDomain)
      */
     public int updateExceptionDeptCode(ExceptionCodeDomain domain) throws ApplicationException {
         return codeDao.updateExceptionDeptCode(domain);
     }
     
     /**
      * {@inheritDoc}
      * 
      * @see com.globaldenso.dnkr.business.service.CodeService#deleteExceptionDeptCode(ExceptionCodeDomain)
      */
     public int deleteExceptionDeptCode(ExceptionCodeDomain domain) throws ApplicationException {
         return codeDao.deleteExceptionDeptCode(domain);
     }
