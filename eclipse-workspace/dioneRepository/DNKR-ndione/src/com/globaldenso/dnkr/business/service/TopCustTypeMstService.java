...
/**
 * [KR] 대표업체차종마스타 서비스 인터페이스. 
 *
 * @author $Author$
 * @version $Revision$
 */
public interface TopCustTypeMstService {
    ...
    * [JP] <br>
    * 
    * @param domain 'TopCustTypeMstDomain' class
    * @return 'TopCustTypeMstDomain' class
    ...
    */
     ...
     * 
     * @param domain 'TopCustTypeMstDomain' class
     * @return List of 'TopCustTypeMstDomain' class
     * @throws ApplicationException Application exception of 'Application Infrastructure'
     */
     ...
     * [JP] <br>
     * 
     * @param domainList List of 'TopCustTypeMstDomain' class
