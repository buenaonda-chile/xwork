...
public interface PsogmService {
    ...
    /**
     * [KO] 기본키로  DB table 에서 설비 정보를 검색하고 결과를 반환한다.<br>
     * [EN] <br>
     * [JP] <br>
     * 
     * @param domain 'MachineDb2Domain' class
    ...
    /**
     * [KO] 사업장코드로 테이블에서 처치정보를 탐색하고 결과를 반환한다.<br>
     * [EN] <br>
     * [JP] <br>
     * 
     * @param domain 'PsogmDomain' class
    ...
    /**
     * [KO] 셋트부품 - 사업장코드와 부품코드로 테이블에서 검색 - 음행을 탐색하고 결과를 반환한다.<br>
     * [EN] <br>
     * [JP] <br>
     * 
     * @param domain 'PsogmDomain' class
    ...
    /**
     * [KO] 예비품 테이블(LIB2.OGM010PF)에 데이터를 업데이트한다.<br>
