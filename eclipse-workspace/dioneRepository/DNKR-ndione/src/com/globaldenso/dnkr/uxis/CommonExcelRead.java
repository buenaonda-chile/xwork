...
public class CommonExcelRead {
    ...
    public List<Map<String, String>> read(String filePath, String type){
        ...
        int numOfRows = sheet.getLastRowNum();//PhysicalNumberOfRows();
        int numOfCells = 0;
        ...
        // 수주이관 : 비서열/확정오더 HOST UP 의 MOBIS AS 구양식 5행부터 Title 시작.
        if("order5".equals(type)){
        	rowIndexTmp = 5;
        }
        /**
         * 각 Row만큼 반복을 한다.
        ...
        for(int rowIndex = rowIndexTmp; rowIndex <= numOfRows; rowIndex++){
            ...
            if(row != null){
                ...
                numOfCells = row.getLastCellNum();//PhysicalNumberOfCells();
                /** 데이터를 담을 맵 객체 초기화    */
        ...
        if(cell == null){
            ...
            switch (cell.getCellType()) {
                ...
                case XSSFCell.CELL_TYPE_NUMERIC:
                	...
                	// HOSPT UP 처리 엑셀 자료의 날짜 서식 확인
                	//if (HSSFDateUtil.isInternalDateFormat(cell.getCellStyle().getDataFormat())) {
                	if (dateFormat == 14 || dateFormat == 165 || dateFormat == 176 || dateFormat == 177) {
