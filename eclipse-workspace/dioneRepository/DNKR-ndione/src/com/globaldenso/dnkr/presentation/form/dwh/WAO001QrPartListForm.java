 ...
 * @version $Revision$
 */
public class WAO001QrPartListForm extends QrPartListDomain implements Cloneable{
    ...
    private String conditionPart[] =null;
    
    private Integer conditionQuantity[] =null;
     ...
     */
    @Override
    public WAO001QrPartListForm clone() {
        WAO001QrPartListForm clone = new WAO001QrPartListForm();
        try {
	...
	public void setQrRead(String qrRead) {
		this.qrRead = qrRead;
	}
