 ...
 * @version $Revision$
 */
public class WAE038HvacSpoolForm extends HvacSpoolDomain implements Cloneable{
     ...
     */
    @Override
    public WAE038HvacSpoolForm clone() {
        WAE038HvacSpoolForm clone = new WAE038HvacSpoolForm();
        try {
