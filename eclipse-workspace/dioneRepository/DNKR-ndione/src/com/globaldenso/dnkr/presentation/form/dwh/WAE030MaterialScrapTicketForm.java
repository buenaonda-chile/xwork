 ...
 * @version $Revision$
 */
public class WAE030MaterialScrapTicketForm extends MaterialWasteDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE030MaterialScrapTicketForm(){
        super();
    }
     ...
     */
    @Override
    public WAE030MaterialScrapTicketForm clone() {
        WAE030MaterialScrapTicketForm clone = new WAE030MaterialScrapTicketForm();
        try {
