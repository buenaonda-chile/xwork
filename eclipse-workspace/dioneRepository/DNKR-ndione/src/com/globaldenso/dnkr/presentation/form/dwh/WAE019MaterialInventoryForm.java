 ...
 * @version $Revision$
 */
public class WAE019MaterialInventoryForm extends MaterialInventoryDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE019MaterialInventoryForm(){
        super();
    }
     ...
     */
    @Override
    public WAE019MaterialInventoryForm clone() {
        WAE019MaterialInventoryForm clone = new WAE019MaterialInventoryForm();
        try {
