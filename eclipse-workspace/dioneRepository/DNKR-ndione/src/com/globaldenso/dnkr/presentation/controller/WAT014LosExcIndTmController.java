 ...
 */
@Controller
@RequestMapping(value = "/WAT014LosExcIndTm")
@ViewId(value = "WAT014")
public class WAT014LosExcIndTmController {
   
    /**
     * [EN] Default constructor.<br>
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAT014LosExcIndTmController() {
        // no process
    }
...
//		mv.addObject("authBinaryNum", UxisCmmUtil.getSessionAuthData(request, MENU_CODE));
		...
		mv.addObject("url", "LosExcIndTm.jsp");
		mv.setViewName(".tiles.page.WAT014");
