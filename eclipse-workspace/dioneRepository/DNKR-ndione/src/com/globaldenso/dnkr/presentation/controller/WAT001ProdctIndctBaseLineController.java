...
/**
 * [KR] 판매계획 기준정보관리(납입구분관리) 컨트롤러<br>
 * 
 * @author $Author$
 * @version $Revision$
 */
@Controller
@RequestMapping(value = "/WAT001ProdctIndctBaseLine")
@ViewId(value = "WAT001")
public class WAT001ProdctIndctBaseLineController {
   
    /**
     * [EN] Default constructor.<br>
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAT001ProdctIndctBaseLineController() {
        // no process
    }
...
//      mv.addObject("authBinaryNum", UxisCmmUtil.getSessionAuthData(request, menu));
        ...
        mv.addObject("url", "ProdctIndctBaseLine.jsp");
        mv.setViewName(".tiles.page.WAT001");
        return mv;
