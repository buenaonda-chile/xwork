...
/**
 * [KR] 생산성지표 기준정보관리(제품코드관리) 컨트롤러<br>
 * 
 * @author $Author$
 * @version $Revision$
 */
@Controller
@RequestMapping(value = "/WAT002ProdctCodeBase")
@ViewId(value = "WAT002")
public class WAT002ProdctCodeBaseController {
    
    /**
     * [EN] Default constructor.<br>
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAT002ProdctCodeBaseController() {
        // no process
    }
...
//      mv.addObject("authBinaryNum", UxisCmmUtil.getSessionAuthData(request, menu));
        ...
        mv.addObject("url", "ProdctCodeBase.jsp");
        mv.setViewName(".tiles.page.WAT002");
        return mv;
