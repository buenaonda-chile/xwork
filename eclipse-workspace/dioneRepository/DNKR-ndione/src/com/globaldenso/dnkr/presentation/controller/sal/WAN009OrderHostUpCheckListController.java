...
/**
 * [KR] 서열형 HOST UP CHECK LIST 컨트롤러<br>
 * 
 * @author $Author$
 * @version $Revision$
 */
@Controller
@RequestMapping(value = "/WAN009OrderHostUpCheckList")
@ViewId(value = "WAN009")
public class WAN009OrderHostUpCheckListController {
    /**
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAN009OrderHostUpCheckListController() {
        // no process
    }
...
//      mv.addObject("authBinaryNum", UxisCmmUtil.getSessionAuthData(request, menu));
        ...
        mv.addObject("url", "OrderHostUpCheckList.jsp");
        mv.setViewName(".tiles.page.WAN009");
        return mv;
