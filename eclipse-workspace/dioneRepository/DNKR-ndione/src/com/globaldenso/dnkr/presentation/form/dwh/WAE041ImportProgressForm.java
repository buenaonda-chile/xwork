 ...
 * @version $Revision$
 */
public class WAE041ImportProgressForm extends ImportProgressDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE041ImportProgressForm(){
        super();
    }
     ...
     */
    @Override
    public WAE041ImportProgressForm clone() {
        WAE041ImportProgressForm clone = new WAE041ImportProgressForm();
        try {
