 ...
 * @version $Revision$
 */
public class WAM001ContractSearchForm extends ContractDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAM001ContractSearchForm(){
        super();
    }
     ...
     */
    @Override
    public WAM001ContractSearchForm clone() {
        WAM001ContractSearchForm clone = new WAM001ContractSearchForm();
        try {
