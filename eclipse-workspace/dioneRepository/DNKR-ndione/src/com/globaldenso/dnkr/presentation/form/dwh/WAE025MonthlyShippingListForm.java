 ...
 * @version $Revision$
 */
public class WAE025MonthlyShippingListForm extends MonthlyShippingListDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE025MonthlyShippingListForm(){
        super();
    }
     ...
     */
    @Override
    public WAE025MonthlyShippingListForm clone() {
        WAE025MonthlyShippingListForm clone = new WAE025MonthlyShippingListForm();
        try {
