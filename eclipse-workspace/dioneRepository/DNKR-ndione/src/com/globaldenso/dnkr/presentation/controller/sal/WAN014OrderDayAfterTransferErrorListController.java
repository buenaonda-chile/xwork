...
/**
 * [KR] 서열형 일일 수주이관후 ERROR LIST 컨트롤러<br>
 * 
 * @author $Author$
 * @version $Revision$
 */
@Controller
@RequestMapping(value = "/WAN014OrderDayAfterTransferErrorList")
@ViewId(value = "WAN014")
public class WAN014OrderDayAfterTransferErrorListController {
    /**
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAN014OrderDayAfterTransferErrorListController() {
        // no process
    }
...
//      mv.addObject("authBinaryNum", UxisCmmUtil.getSessionAuthData(request, menu));
        ...
        mv.addObject("url", "OrderDayAfterTransferErrorList.jsp");
        mv.setViewName(".tiles.page.WAN014");
        return mv;
