...
/**
 * [KR] 기아현대 VAN 업체코드마스타 컨트롤러<br>
 * 
 * @author $Author$
 * @version $Revision$
 */
@Controller
@RequestMapping(value = "/WAN019KiaHyundaiVANCompanyCodeMst")
@ViewId(value = "WAN019")
public class WAN019KiaHyundaiVANCompanyCodeMstController {
    /**
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAN019KiaHyundaiVANCompanyCodeMstController() {
        // no process
    }
...
//      mv.addObject("authBinaryNum", UxisCmmUtil.getSessionAuthData(request, menu));
        ...
        mv.addObject("url", "KiaHyundaiVANCompanyCodeMst.jsp");
        mv.setViewName(".tiles.page.WAN019");
        return mv;
