 ...
 */
@Controller
@RequestMapping(value = "/WAF011PsogmPsfacAsUnitPCreate")
@ViewId(value = "WAF011")
public class WAF011PsogmPsfacAsUnitPCreateController {
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAF011PsogmPsfacAsUnitPCreateController() {
        // no process
    }
...
//          list = psogmService.getogm313_cmbprtcd(domain);
        ...
        mv.setViewName(".tiles.page.WAF011");
        return mv;
    }
