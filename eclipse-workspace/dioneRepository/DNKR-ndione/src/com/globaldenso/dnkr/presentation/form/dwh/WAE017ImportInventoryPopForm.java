 ...
 * @version $Revision$
 */
public class WAE017ImportInventoryPopForm extends ImportInventoryPopDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE017ImportInventoryPopForm(){
        super();
    }
     ...
     */
    @Override
    public WAE017ImportInventoryPopForm clone() {
        WAE017ImportInventoryPopForm clone = new WAE017ImportInventoryPopForm();
        try {
