...
public class WAF007PsogmMachineSearchForm extends PsogmMachineDomain implements Cloneable{

	/**
	 * Serial Version UID.
	 */
	private static final long serialVersionUID = 507465091619242095L;
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAF007PsogmMachineSearchForm(){
    	 super();
    }
     ...
     */
    @Override
    public WAF007PsogmMachineSearchForm clone() {
        WAF007PsogmMachineSearchForm clone = new WAF007PsogmMachineSearchForm();
        try {
