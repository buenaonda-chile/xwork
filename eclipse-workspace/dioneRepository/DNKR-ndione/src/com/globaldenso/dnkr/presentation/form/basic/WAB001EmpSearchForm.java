 ...
 * @version $Revision$
 */
public class WAB001EmpSearchForm extends EmpDomain implements Cloneable{
     ...
     */
    @Override
    public WAB001EmpSearchForm clone() {
        WAB001EmpSearchForm clone = new WAB001EmpSearchForm();
        try {
