 ...
 * @version $Revision$
 */
public class WAE033ProductionRecordForm extends ProductionRecordDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE033ProductionRecordForm(){
        super();
    }
     ...
     */
    @Override
    public WAE033ProductionRecordForm clone() {
        WAE033ProductionRecordForm clone = new WAE033ProductionRecordForm();
        try {
