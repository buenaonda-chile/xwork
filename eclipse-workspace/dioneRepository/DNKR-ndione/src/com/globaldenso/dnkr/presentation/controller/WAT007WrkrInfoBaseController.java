 ...
 */
@Controller
@RequestMapping(value = "/WAT007WrkrInfoBase")
@ViewId(value = "WAT007")
public class WAT007WrkrInfoBaseController {    
    /**
     * [EN] Default constructor.<br>
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAT007WrkrInfoBaseController() {
        // no process
    }
  ...
  //      mv.addObject("authBinaryNum", UxisCmmUtil.getSessionAuthData(request, menu));
        ...
        mv.addObject("url", "WrkrInfoBase.jsp");
        mv.setViewName(".tiles.page.WAT007");
        return mv;
