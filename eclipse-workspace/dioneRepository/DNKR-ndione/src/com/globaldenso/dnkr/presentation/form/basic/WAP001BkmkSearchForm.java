 ...
 * @version $Revision$
 */
public class WAP001BkmkSearchForm extends BkmkDomain implements Cloneable{
     ...
     */
    @Override
    public WAP001BkmkSearchForm clone() {
        WAP001BkmkSearchForm clone = new WAP001BkmkSearchForm();
        try {
