 ...
 */
@Controller
@RequestMapping(value = "/WAE003SalesPlanMaterialCostSearch")
@ViewId(value = "WAE003")
public class WAE003SalesPlanMaterialCostController {
	 ...
	 * [JP] デフォルトコンストラクタ。<br>
	 */
	public WAE003SalesPlanMaterialCostController() {
		// no process
	}
	...
	public ModelAndView initSalesPlanMaterialCost(HttpServletRequest request,
			@ModelAttribute("WAE003SalesPlanMaterialCostForm") WAE003SalesPlanMaterialCostForm form)
			throws Exception {
		/**
		 * <pre>
		 *             
		...
		mv.addObject("url", "WAE003SalesPlanMaterialCostSearch.jsp");
		mv.setViewName(".tiles.page.WAE003SalesPlanMaterialCostSearch");
		return mv;
	}
	...
	public ModelAndView salesPlanMaterialCostSearch(HttpServletRequest request,
		...
		List<SalesPlanMaterialCostDomain> salesPlanMaterialCostList = null;
		try {
			salesPlanMaterialCostList = mifService.searchBySalesPlanMaterialCost(form);
		} catch (Exception e) {
			e.printStackTrace();
		}
