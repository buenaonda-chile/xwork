 ...
 * @version $Revision$
 */
public class WAD013ExceptionCodeMngSearchForm extends ExceptionCodeDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAD013ExceptionCodeMngSearchForm(){
        super();
    }
     ...
     */
    @Override
    public WAD013ExceptionCodeMngSearchForm clone() {
        WAD013ExceptionCodeMngSearchForm clone = new WAD013ExceptionCodeMngSearchForm();
        try {
