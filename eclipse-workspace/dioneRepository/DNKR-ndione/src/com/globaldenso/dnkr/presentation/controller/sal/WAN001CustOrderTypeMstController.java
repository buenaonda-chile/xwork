...
/**
 * [KR] 업체서열차종마스타 컨트롤러<br>
 * 
 * @author $Author$
 * @version $Revision$
 */
@Controller
@RequestMapping(value = "/WAN001CustOrderTypeMst")
@ViewId(value = "WAN001")
public class WAN001CustOrderTypeMstController {
    /**
     * [KR] 업체서열차종마스타 서비스 <br>     
     */
    @Autowired
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAN001CustOrderTypeMstController() {
        // no process
    }
...
//      mv.addObject("authBinaryNum", UxisCmmUtil.getSessionAuthData(request, menu));
        ...
        mv.addObject("url", "CustOrderTypeMst.jsp");
        mv.setViewName(".tiles.page.WAN001");
        return mv;
