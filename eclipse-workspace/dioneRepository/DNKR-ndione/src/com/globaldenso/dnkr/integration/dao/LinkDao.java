...
public interface LinkDao {
     ...
     * [EN] Search link information from DB table by any conditions, and return the count of the search result.<br>
     * [JP] <br>
     * 
     ...
     * [EN] (For paging processing) Search link information from DB table by any conditions, and return the search results in a list.<br>
     * [JP] (ページング処理用)<br>
     * 
     * @param domain 'LinkDomain' class
