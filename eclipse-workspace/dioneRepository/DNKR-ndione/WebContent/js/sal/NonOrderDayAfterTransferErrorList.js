...
function setList(params, _pageNo, gridTarget) {
	...
	$.ajax({
		method : "post",
		url : "/ajaxNonOrderDayAfterTransferErrorList/init.do",
		data : ajaxParams,
...
function search() {
	...
	$.ajax({
		method : "post",
		url : "/ajaxNonOrderDayAfterTransferErrorList/search.do",
		data : {
...
$(document.body).ready(function() {
	...
	$('._excelBtn_').on('click', function() {
		grid.target.exportExcel("비서열/확정오더형 일일 수주이관후 ERROR LIST.xls");
	});
});
