...
var LB_LGS_DST_RT = "<spring:message code='label.WAT003.lgs_dst_rt'/>";
		...
		<div style="margin: 0px 15px 0px 0px;">
			<div class="k_cg1" style="text-align: center">
				<div class="k_sg1 gridBtnBlock" style="text-align: center">
					...
					<select id="getComps" name="getComps" class="getComps schLine">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/prdind/LgstTimeDstrRtBase.js"></script>