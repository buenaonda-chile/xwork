...
var LB_CODE_NM = "<spring:message code='label.WAT001.codeNm'/>";
var LB_OVERTIME_H = "<spring:message code='label.WAT005.ovrtimeH'/>";
var LB_OVERTIME_M = "<spring:message code='label.WAT005.ovrtimeM'/>";
		...
		<div style="margin: 0px 15px 0px 0px;">
			<div class="k_cg1" style="text-align: center">
				<div class="k_sg1 gridBtnBlock" style="text-align: center">
					...
					<label class="k_l1">코드구분</label>			
					<select id="getSe" name="getSe" class="getComps schLine" onchange="changeSe();">
						<option value="A">근무코드</option>
						<option value="B">제외코드</option>
						<option value="C">간접코드</option>
						<option value="D">손실코드</option>
						<option value="E">빵/쿠폰</option>
						<option value="F">근무형태(교대구분)</option>
						<option value="G">조</option>
						<option value="H">년계획기준등록항목</option>																														
					</select>						
				</div>	
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/prdind/WorkCodeBase.js"></script>