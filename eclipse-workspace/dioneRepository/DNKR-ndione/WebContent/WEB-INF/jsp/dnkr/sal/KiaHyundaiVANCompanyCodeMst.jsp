...
var LN_CHK_VNDCD = "<spring:message code='label.WAN019.vndcd'/>";
var LN_CHK_FACCD = "<spring:message code='label.WAN019.faccd'/>";
var LN_CHK_FACNM = "<spring:message code='label.WAN019.facnm'/>";
var LN_CHK_PSCOM = "<spring:message code='label.WAN019.pscom'/>";
var LN_CHK_PSVND1 = "<spring:message code='label.WAN019.psvnd'/>";
var LN_CHK_SEQNO = "<spring:message code='label.WAN019.seqno'/>";
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/sal/KiaHyundaiVANCompanyCodeMst.js?ver=1.1"></script>