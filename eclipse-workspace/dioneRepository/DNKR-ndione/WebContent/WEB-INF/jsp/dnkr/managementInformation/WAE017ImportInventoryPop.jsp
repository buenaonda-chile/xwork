...
<table class="pd-s-table" style="margin-top:20px;">
	...
	<tbody>
		<input type="text" name="comps" id="comps" hidden="true" value="${paraDomain.comps}" /></td> 
		<input type="text" name="locCode" id="locCode" hidden="true" value="${paraDomain.locCode}" /></td> 
		<tr>
