...
$(document).ready(function(){
	...
	$('#jqGridList').jqGrid({ 
	    datatype: 'json', 
	    mtype: 'POST',
	    url: 'getEduSelectList.do',
	    //ajaxGridOptions: { contentType: "application/json;charset=utf-8" },
	    postData : fn_getFormData('#application_form'),
	    colNames : ['SEQ', '교육제목', '교육기간', '등록일', '등록자', '팀', '완료여부', '참여여부', 'OPER'],
	    colModel : [
		...
		onCellSelect : function(row_id, iCol) {
			...
			if(row_id != null) {
				...
				if(item.status_cnt < 1) {
					location.href = "eduUser.do?edu_pk=" + item.pk;
				}
	        }
		}
	}); //end of jqGrid
        ...
        <div class="doc-wrap" id="docBaseWrap">
            <div class="layout-LW">
                ...
                <div class="left" style="width:923px;">
                    ...
                    <h2 class="subpage-tit"><spring:message code='label.eduUserList1'/></h2>
                    <div class="search">
                        <div id="btnSearch" >
                        	<a class="button">
                        		<i class="w_search"></i>
                        		<span><spring:message code='label.eduUserList2'/></span>
                        	</a>
                        </div>
                        <div class="center_search_container">
                            <p><spring:message code='label.eduUserList3'/></p>
                            <input type="text" id="p_subject" name="p_subject" value="" />
                            <p><spring:message code='label.eduUserList4'/></p>
