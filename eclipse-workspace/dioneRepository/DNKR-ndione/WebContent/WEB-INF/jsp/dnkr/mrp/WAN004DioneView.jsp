...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/mrp/WAN004DioneView.js"></script>
			...
			<TABLE  id="test" cellpadding="0" cellspacing="0" border="0" height="100%" width="100%" >
				<TR>
					<TD align="center" valign="middle">				
						<OBJECT ID="MiPlatformCtrl"  width="100%" height="925px" bgcolor="red" Visible="true" CLASSID="CLSID:3F4762E6-3DBD-458C-9BE8-10C0F26C969D">
							<param NAME="AutoSize" VALUE="false">
							<param NAME="Key" VALUE="callDione">
				            <param NAME="wmode" VALUE="opaque"></param>
				            <!-- 
							<param NAME="startxml" VALUE="http://10.73.254.21/ui/denso_ci_main_Win32_Inf.xml"> <%-- 실환경  --%>
							<param NAME="startxml" VALUE="http://10.74.227.115/ui/denso_ci_main_Win32_Inf.xml"> <%-- TEST환경 --%>
							 -->
							 <param NAME="startxml" VALUE="http://dione.dnka.kr/ui/denso_ci_main_Win32_Inf.xml">
