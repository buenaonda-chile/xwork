...
<script language="JavaScript" type="text/javascript">
	...
	function fn_OnLoad()
	{
		...
		//MiInstaller.StartXml  = "http://10.74.227.115/ui/newDione_Session3_Win32.xml";	//개발환경
		MiInstaller.StartXml  = "http://dione.dnke.kr/ui/newDione_Session3_Win32.xml";	//서버환경
	...
	function fn_run()
	{
		...
		//location.href = "http://10.74.227.115/sessionDisplay4.jsp?EmpNo='"+empNo+"'&Company='"+company+"'&PlantCd='"+plantCd+"'";
		if(sessionCnt > 3){
			location.href = "sessionDisplay4.jsp?EmpNo='"+empNo+"'&Company='"+company+"'&PlantCd='"+plantCd+"'&SessionCnt="+sessionCnt;
			//location.href = "http://10.73.254.21/sessionDisplay4.jsp?EmpNo='"+empNo+"'&Company='"+company+"'&PlantCd='"+plantCd+"'&SessionCnt="+sessionCnt;
		}else{
			CloseWnd(); // 익스플로어 7 이상 종료 함수
		}
	}
