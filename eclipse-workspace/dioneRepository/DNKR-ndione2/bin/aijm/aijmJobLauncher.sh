#!/bin/bash
# ****************************************************************************
# ** [JP]  ファイル名 : aijmJobLauncher.sh
# ** [JP]  処理概要   : スケジュール/リクエストジョブを起動する共通のバッチです。
# ** [JP]
# ** [JP]    AijmMainControllerから起動する全てのスケジュール/リクエストジョブは
# ** [JP]    このバッチから起動させます。
# ** [JP]
# ** [JP]   【引数】
...
# ** [JP]      $3 : 実行するキューID
# **
# ** [EN]  File name : aijmJobLauncher.sh
# ** [EN]  Outline of processing   : It is common to start the batch schedule job / request job.
# ** [EN]
# ** [EN]    All schedule jobs / request jobs from AijmMainController start, launch from this batch.
# ** [EN]
# ** [EN]   【Argument】
...
# **
# **  $ aijmJobLauncher.sh 1706 2015-06-12 02:40:40Z 815372040074 $
# **
# ****************************************************************************
...
EXECUTE_CLASS=com.globaldenso.ai.akatsuki.aijm.job.control.JobLauncher
...
# [EN] ==== Starting job ========================================
export CLASSPATH
${JAVA_HOME}/bin/java -Xrs -Xmx${JAVA_XMX}m -Xms${JAVA_XMS}m -XX:MetaspaceSize=${JAVA_METASIZE}m -XX:MaxMetaspaceSize=${JAVA_METASIZE}m -Dlog4j.configurationFile=${LOG_XML} ${EXECUTE_CLASS} $1 $3 >> ${BATCH_LOG_DIR}/$2/$3.log
exit
