...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/admin/WAC023SsoAccountDevice.js"></script>
<!-- [EN] Contents area -->
...
<%-- 				
				...
				<%-- Device ID--%>
				<strong class="pr5">Device ID<%-- <spring:message code='label.deviceId'/> --%><%-- Device ID --%></strong>
				<input type="text" name="deviceId" id="deviceId" style="width: 200px; padding: 0 20px" maxlength="15" placeholder="DeviceID입력"/>
			...
			<table>
				<tr>
					<td rowspan="2"><strong>사용자List</strong>
						<div style="position: relative; height: 600px; width:760px;" id="grid-parent">
					...
					<td><strong><spring:message code='label.WAB002.employee'/> : <span class="applyUserName"></span></strong>
						<div style="position: relative; height: 250px; width:760px;" id="grid-parent2">
						...
						<div style="padding: 10px;">                                                          
							<button type="button" class="btn btn-default" data-grid-control="row-add">row add</button>      
							<button type="button" class="btn btn-default" data-grid-control="row-remove">row remove</button>
							<!-- <button type="button" class="btn btn-default" data-grid-control="row-update">row update</button> -->
						</div> 
					</td>
				</tr>
				<tr>
					<td><strong>공장 : <span class="applyUserCompany"></span></strong>
						<div style="position: relative; height: 250px; width:760px;" id="grid-parent3">
