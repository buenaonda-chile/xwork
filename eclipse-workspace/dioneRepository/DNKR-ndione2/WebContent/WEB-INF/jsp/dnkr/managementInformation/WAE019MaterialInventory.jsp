...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/dwh/WAE019MaterialInventory.js"></script>
<!-- [EN] Contents area -->
		...
		<div class="searchCondition">
			...
			<div class="top-bar cb">
				...
				<strong class="pr5"><spring:message code='label.selectMenu'/><%-- 자료선택--%></label></strong>
					<input type="radio" name="selectMenu" value="DWH151PF" onclick="commonClear(this)" checked="checked">재고현황
					<input type="radio" name="selectMenu" value="DWH155PF" onclick="commonClear(this)"> 자재입출고재고현황
				<!-- 조회년도를 선택해주세요 -->
				...
				<strong class="pr5">*매월 자재마감작업후 DATA가 생성됩니다.</strong> 	
