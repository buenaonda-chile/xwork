...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/dwh/WAE034ProductShippingReceiving.js"></script>
<!-- [EN] Contents area -->
	...
	<form:form>
		<div class="searchCondition">
			...
			<div class="top-bar cb">
				...
				<strong class="pr5">*매월 자재마감후에 DATA가 생성됩니다.</strong> 	
