...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/dwh/WAE003SalesPlanMeterialCostSearch.js"></script>
<!-- [EN] Contents area -->
	...
	<form:form>
		<div class="searchCondition">
			...
			<div class="top-bar cb">
				...
				<!-- 조회년도를 선택해주세요 -->	
				&nbsp;						
				<strong class="pr5">년도</strong>
				<div class="date-inwrap" data-ax5picker="basic" style="width: 80px;">
					<span class="calendar_icon_b vcen2 c1"></span> <input type="text"
						name="year" id="year" style="width: 80px; padding: 0 0px 0px 35px"
				...
				<select name="division" id="division">
					<option value="1">1.기본계획</option>
					<option value="2">2.수정계획</option>					
				</select>
				...
				<div class="fr">
					...
					<button class="green btn-st02 exel" type="button" name="Search">
