 ...
 * @version $Revision$
 */
public class WAE001MngSearchForm extends DataWareHouseDomain implements Cloneable{
     ...
     */
    @Override
    public WAE001MngSearchForm clone() {
        WAE001MngSearchForm clone = new WAE001MngSearchForm();
        try {
