 ...
 * @version $Revision$
 */
public class WAE034ProductShippingReceivingForm extends ProductShippingReceivingDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE034ProductShippingReceivingForm(){
        super();
    }
     ...
     */
    @Override
    public WAE034ProductShippingReceivingForm clone() {
        WAE034ProductShippingReceivingForm clone = new WAE034ProductShippingReceivingForm();
        try {
