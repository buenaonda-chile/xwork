 ...
 * @version $Revision$
 */
public class WAE029MaterialWasteForm extends MaterialWasteDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE029MaterialWasteForm(){
        super();
    }
     ...
     */
    @Override
    public WAE029MaterialWasteForm clone() {
        WAE029MaterialWasteForm clone = new WAE029MaterialWasteForm();
        try {
