 ...
 * @version $Revision$
 */
public class WAE039AccountingJournalForm extends AccountingJournalDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE039AccountingJournalForm(){
        super();
    }
     ...
     */
    @Override
    public WAE039AccountingJournalForm clone() {
        WAE039AccountingJournalForm clone = new WAE039AccountingJournalForm();
        try {
