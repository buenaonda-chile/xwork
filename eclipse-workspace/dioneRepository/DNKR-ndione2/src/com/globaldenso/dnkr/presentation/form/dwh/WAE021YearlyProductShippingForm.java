 ...
 * @version $Revision$
 */
public class WAE021YearlyProductShippingForm extends YearlyProductShippingDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE021YearlyProductShippingForm(){
        super();
    }
     ...
     */
    @Override
    public WAE021YearlyProductShippingForm clone() {
        WAE021YearlyProductShippingForm clone = new WAE021YearlyProductShippingForm();
        try {
