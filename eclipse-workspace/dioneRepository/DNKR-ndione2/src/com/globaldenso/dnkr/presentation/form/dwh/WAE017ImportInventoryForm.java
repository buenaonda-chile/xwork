 ...
 * @version $Revision$
 */
public class WAE017ImportInventoryForm extends ImportInventoryDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE017ImportInventoryForm(){
        super();
    }
     ...
     */
    @Override
    public WAE017ImportInventoryForm clone() {
        WAE017ImportInventoryForm clone = new WAE017ImportInventoryForm();
        try {
