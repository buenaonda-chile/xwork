 ...
 */
@Controller
@RequestMapping(value = "/WAF017PssalInspect")
@ViewId(value = "WAF017")
public class WAF017PssalInspectController {
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAF017PssalInspectController() {
        // no process
    }
    ...
    public ModelAndView init(HttpServletRequest request) throws Exception {
        ...
        System.out.println("/WAF017PssalInspect");
...
//          list = psogmService.getogm313_cmbprtcd(domain);
        ...
        mv.addObject("url", "WAF017PssalInspect.jsp");
        mv.setViewName(".tiles.page.WAF017");
        return mv;
    }
