 ...
 * @version $Revision$
 */
public class WAE015ProductStockShippingReceivingForm extends ProductStockShippingReceivingDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE015ProductStockShippingReceivingForm(){
        super();
    }
     ...
     */
    @Override
    public WAE015ProductStockShippingReceivingForm clone() {
        WAE015ProductStockShippingReceivingForm clone = new WAE015ProductStockShippingReceivingForm();
        try {
