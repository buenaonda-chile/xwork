 ...
 * @version $Revision$
 */
public class WAE037DupPartCheckForm extends DuplicationPartDomain implements Cloneable{
     ...
     */
    @Override
    public WAE037DupPartCheckForm clone() {
        WAE037DupPartCheckForm clone = new WAE037DupPartCheckForm();
        try {
