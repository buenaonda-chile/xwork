 ...
 * @version $Revision$
 */
public class WAC016LogSearchForm extends LogDomain implements Cloneable{
     ...
     */
    @Override
    public WAC016LogSearchForm clone() {
        WAC016LogSearchForm clone = new WAC016LogSearchForm();
        try {
