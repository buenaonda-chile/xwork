 ...
 * @version $Revision$
 */
public class WAE028FakeSalesCheckListgForm extends FakeSalesCheckListDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE028FakeSalesCheckListgForm(){
        super();
    }
     ...
     */
    @Override
    public WAE028FakeSalesCheckListgForm clone() {
        WAE028FakeSalesCheckListgForm clone = new WAE028FakeSalesCheckListgForm();
        try {
