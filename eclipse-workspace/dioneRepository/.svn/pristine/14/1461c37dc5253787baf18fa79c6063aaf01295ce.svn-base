...
//    mv.addObject("modelItems", modelList);
  ...
  public ModelAndView searchSd(ServiceSearchForm criteria, Pageable pageable) throws Exception {

    Page<ServiceDto> serviceItems = serviceService.searchBySdCondition(criteria, pageable);
  ...
  public ModelAndView create(@RequestBody ServiceForm serviceForm) throws Exception {

    ModelAndView mv = new ModelAndView("jsonView");

    serviceService.create(serviceForm);

    ServiceDto serviceDto = serviceService.searchByKey(serviceForm);
    serviceForm.setManageNo(serviceDto.getManageNo());

    mv.addObject("data", serviceForm);

    return mv;
  }

  @RequestMapping(method = RequestMethod.POST, value="/update")
  public ModelAndView update(@RequestBody ServiceForm serviceForm) throws Exception {
  ...
  public ModelAndView delete(@RequestBody ServiceForm serviceForm) throws Exception {

    ModelAndView mv = new ModelAndView("jsonView");
    serviceService.delete(serviceForm);
