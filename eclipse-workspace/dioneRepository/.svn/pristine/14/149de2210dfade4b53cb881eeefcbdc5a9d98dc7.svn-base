 ...
 */
@Controller
@RequestMapping(value = "/WAF010PsogmProdInfoSearch")
@ViewId(value = "WAF010")
public class WAF010PsogmProdInfoSearchController {
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAF010PsogmProdInfoSearchController() {
        // no process
    }
    ...
    public ModelAndView init(HttpServletRequest request) throws Exception {
        ...
        System.out.println("/WAF010PsogmProdInfoSearch");
...
//          list = psogmService.getogm313_cmbprtcd(domain);
        ...
        mv.addObject("url", "WAF010PsogmProdInfoSearch.jsp");
        mv.setViewName(".tiles.page.WAF010");
        return mv;
    }
