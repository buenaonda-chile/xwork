 ...
 * @version $Revision$
 */
public class WAE024BusinessShippingForm extends BusinessShippingDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE024BusinessShippingForm(){
        super();
    }
     ...
     */
    @Override
    public WAE024BusinessShippingForm clone() {
        WAE024BusinessShippingForm clone = new WAE024BusinessShippingForm();
        try {
