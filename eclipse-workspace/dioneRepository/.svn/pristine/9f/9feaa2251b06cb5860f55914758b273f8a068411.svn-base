 ...
 * @version $Revision$
 */
public class WAE022ShippingSalesForm extends ShippingSalesDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE022ShippingSalesForm(){
        super();
    }
     ...
     */
    @Override
    public WAE022ShippingSalesForm clone() {
        WAE022ShippingSalesForm clone = new WAE022ShippingSalesForm();
        try {
