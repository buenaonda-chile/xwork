...
/**
 * [KR] 비서열/확정오더형 일일 수주이관후 ERROR LIST 도메인 클레스 <br>
 * 
 * 
 * @author $Author$
 * @version $Revision$
 */
public class NonOrderDayAfterTransferErrorListDomain implements Serializable {
