...
/**
 * [KR] 업체서열차종마스타차종별조회 서비스 인터페이스. 
 *
 * @author $Author$
 * @version $Revision$
 */
public interface CustOrderTypeMstViewService {
    ...
    * [JP] <br>
    * 
    * @param domain 'CustOrderTypeMstViewDomain' class
    * @return 'CustOrderTypeMstViewDomain' class
    ...
    */
     ...
     * 
     * @param domain 'CustOrderTypeMstViewDomain' class
     * @return List of 'CustOrderTypeMstViewDomain' class
     * @throws ApplicationException Application exception of 'Application Infrastructure'
     */
