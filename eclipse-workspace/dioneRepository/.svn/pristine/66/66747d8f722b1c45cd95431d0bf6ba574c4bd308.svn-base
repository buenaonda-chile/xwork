...
<html>
    <head>
	    ...
	    <link type="text/css" href="${pageContext.request.contextPath}/css/ui.jqgrid.css" rel="stylesheet" /> <!--jqgrid-4.6.0  -->
	    <link type="text/css" href="${pageContext.request.contextPath}/css/ui.jqgrid-reset.css" rel="stylesheet" />
