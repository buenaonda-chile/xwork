...
function gridInit(){
	var columnsDefinition=[
		...
		{ header: '* '+ LB_WORK_DIV, align: 'center',  columns: [
			{binding:'workStle',header: '* '+ LB_CODE,width: '*', align:'center',dataType:'String', maxLength:2},
		...
		{ header: '* '+ LB_GROUP, align: 'center',  columns: [
			{binding:'group',header: '* '+ LB_CODE,width: '*', align:'center',dataType:'String', maxLength:2},
