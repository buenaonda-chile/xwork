...
/**
 * [KR] 업체부품구성마스타 서비스 인터페이스. 
 *
 * @author $Author$
 * @version $Revision$
 */
public interface CustPartConstMstService {
    ...
    * [JP] <br>
    * 
    * @param domain 'CustPartConstMstDomain' class
    * @return 'CustPartConstMstDomain' class
    ...
    */
     ...
     * 
     * @param domain 'CustPartConstMstDomain' class
     * @return List of 'CustPartConstMstDomain' class
     * @throws ApplicationException Application exception of 'Application Infrastructure'
     */
     ...
     * [JP] <br>
     * 
     * @param domainList List of 'CustPartConstMstDomain' class
