...
var LB_SERVC_NO = "<spring:message code='label.WAT008.servcNo'/>";//용역번호
var LB_LOC_CODE = "<spring:message code='label.WAT008.locCode'/>";//부서코드
var LB_LOC_NM = "<spring:message code='label.WAT008.locNm'/>";
var LB_START_DE = "<spring:message code='label.WAT008.startDe'/>";//시작일자
var LB_END_DE = "<spring:message code='label.WAT008.endDe'/>";//종료일자
var LB_NM = "<spring:message code='label.WAT008.nm'/>";//성명
var LB_REFRN = "<spring:message code='label.WAT002.refrn'/>";//참조
		...
		<div style="margin: 0px 15px 0px 0px;">
			<div class="k_cg1" style="text-align: center">
				<div class="k_sg1 gridBtnBlock" style="text-align: center">
					...
					<label class="k_l1"><spring:message code='label.WAT008.servcNo' /></label><!-- 용역번호 -->
					<input type="text" class="AXInput getServcNo" style="width: 160px;" name="servcNo" id="servcNo" maxlength="30">
				</div>	
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/prdind/PrdctSvcPsnlInput.js"></script>