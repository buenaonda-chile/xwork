...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/dwh/WAE011ImportDressingHistory.js"></script>
<!-- [EN] Contents area -->
	...
	<form:form>
		...
		<div class="sssgap"></div>
			<div class="top-bar cb">				
				...
				<input type="radio" name="selectMenu" value="summary" onclick="commonClear()" checked="checked"> 집계
				<input type="radio" name="selectMenu" value="detail" onclick="commonClear()"> 내역
					
				<!-- 조회년도를 선택해주세요 -->
				&nbsp;&nbsp;&nbsp; 
				<strong class="pr5"><spring:message code='label.WAK001.list3'/><%-- 년월일 --%></strong>
