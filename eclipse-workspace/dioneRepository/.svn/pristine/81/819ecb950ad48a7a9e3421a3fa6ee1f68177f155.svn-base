 ...
 * @version $Revision$
 */
public class WAE020ProductInventoryCostForm extends ProductInventoryDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE020ProductInventoryCostForm(){
        super();
    }
     ...
     */
    @Override
    public WAE020ProductInventoryCostForm clone() {
        WAE020ProductInventoryCostForm clone = new WAE020ProductInventoryCostForm();
        try {
