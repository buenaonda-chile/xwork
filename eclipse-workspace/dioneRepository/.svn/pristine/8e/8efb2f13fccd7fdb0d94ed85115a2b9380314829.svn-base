...
/**
 * [KR] 업체서열차종마스타차종별조회 컨트롤러<br>
 * 
 * @author $Author$
 * @version $Revision$
 */
@Controller
@RequestMapping(value = "/WAN006CustOrderTypeMstView")
@ViewId(value = "WAN006")
public class WAN006CustOrderTypeMstViewController {
    /**
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAN006CustOrderTypeMstViewController() {
        // no process
    }
...
//      mv.addObject("authBinaryNum", UxisCmmUtil.getSessionAuthData(request, menu));
        ...
        mv.addObject("url", "CustOrderTypeMstView.jsp");
        mv.setViewName(".tiles.page.WAN006");
        return mv;
