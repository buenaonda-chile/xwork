...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/dwh/WAE001MaterialReceiving.js"></script>
<!-- [EN] Contents area -->
		...
		<div class="searchCondition">
			...
			<div class="top-bar cb">
				...
				<div class="date-inwrap" data-ax5picker="basic" style="width: 140px;">
					...
					<input type="text" name="year" id="year" style="width: 140px; padding: 0 40px"
