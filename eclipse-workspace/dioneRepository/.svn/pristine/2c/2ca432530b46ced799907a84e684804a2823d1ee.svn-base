 ...
 * @version $Revision$
 */
public class WAC021SsoAccountForm extends SsoAccountDomain implements Cloneable{
     ...
     */
    @Override
    public WAC021SsoAccountForm clone() {
        WAC021SsoAccountForm clone = new WAC021SsoAccountForm();
        try {
