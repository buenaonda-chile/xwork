...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/sal/OrderDaySaleCreate.js?ver"></script>
...
.k_cg1 .k_bg1{width:50px;}
.k_cg1 .k_sg1{width:calc(100% - 50px);}
	...
	<div class="gridContents" style="" id="grid-parent">
		<div class="k_cg1">
			<div class="gridBtnBlock k_bg1">
				<button type="button" class="AXButton Blue _createBtn_" onclick="create();">
					<span><spring:message code='label.WAN010.create'/></span>
				</button>
			</div>
			...
			<div calss="fr" style="padding-top:15px;">
				<!-- * ì£¼ì : 1100ì ìì°,ì¸ì° HOST UPí ììë°ëëë¤.</p>
				- ì¸ì°,ì ì£¼ê³µì¥ì P6,P7 DATAë¡ ì¼ì¼íë§¤ê° ìì±ë©ëë¤.</p>
				- ìì°ê³µì¥ì PC,PD DATAë¡ ì¼ì¼íë§¤ê° ìì±ë©ëë¤. -->
			</div>
		</div>
	</div>
</div>
