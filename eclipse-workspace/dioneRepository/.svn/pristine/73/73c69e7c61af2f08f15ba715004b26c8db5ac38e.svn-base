...
<script language="JavaScript" type="text/javascript">
	...
	function fn_OnLoad()
	{
		...
		//MiInstaller.StartXml  = "http://10.74.227.115/ui/newDione_NewSession3_Win32.xml";	//서버환경
		MiInstaller.StartXml  = "http://dione.dnke.kr/ui/newDione_NewSession3_Win32.xml";	//서버환경
