 ...
 * @version $Revision$
 */
public class WAE027AccountSituationForm extends AccountSituationDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE027AccountSituationForm(){
        super();
    }
     ...
     */
    @Override
    public WAE027AccountSituationForm clone() {
        WAE027AccountSituationForm clone = new WAE027AccountSituationForm();
        try {
