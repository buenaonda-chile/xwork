 ...
 */
@Controller
@RequestMapping(value = "/WAS007SalPlnPerfmncMtReprtExl")
@ViewId(value = "WAS007")
public class WAS007SalPlnPerfmncMtReprtExlController {
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAS007SalPlnPerfmncMtReprtExlController() {
        // no process
    }
...
//      mv.addObject("authBinaryNum", UxisCmmUtil.getSessionAuthData(request, menu));
        ...
        mv.addObject("url", "WAS007SalPlnPerfmncMtReprtExl.jsp");
        mv.setViewName(".tiles.page.WAS007");
        return mv;
