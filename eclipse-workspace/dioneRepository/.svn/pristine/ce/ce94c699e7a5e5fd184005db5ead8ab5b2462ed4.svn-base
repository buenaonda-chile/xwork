...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/dwh/WAE028FakeSalesCheckList.js"></script>
<!-- [EN] Contents area -->
	...
	<form:form>
		<div class="searchCondition">
			...
			<div class="top-bar cb">	
				...
				<strong class="pr5">*매월 세금계산서 이관후 DATA가 생성됩니다.</strong> 	
