...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/dwh/WAE036DailyDepartmentCost.js"></script>
<!-- [EN] Contents area -->
			...
			<div class="top-bar cb">
				...
				<div class="date-inwrap" data-ax5picker="basic"
					...
					<span class="calendar_icon_b vcen2 c1"></span> <input type="text"
						name="jyymm" id="jyymm" style="width: 140px; padding: 0 40px"
