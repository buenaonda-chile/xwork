...
var LB_START_DE = "<spring:message code='label.WAT002.startDe'/>";
var LB_END_DE = "<spring:message code='label.WAT002.endDe'/>";
		...
		<div style="margin: 0px 15px 0px 0px;">
			<div class="k_cg1" style="text-align: center">
				<div class="k_sg1 gridBtnBlock" style="text-align: center">
					<label class="k_l1"><spring:message code='label.WAT002.prdtCode'/></label>
					<input type="text" class="AXInput getPyvnd" style="width : 100px;" name="code" id="code" >
					<label class="k_l1"><spring:message code='label.WAT002.prdtNm'/></label>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/prdind/ProdctCodeBase.js"></script>
