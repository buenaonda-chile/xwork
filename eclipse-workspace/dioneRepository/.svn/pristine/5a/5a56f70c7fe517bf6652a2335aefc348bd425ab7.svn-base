var commonGridInit = function(flexGrid,cv){
...
//			else {
//				if(typeof VIW_ID != "undefined" && VIW_ID != "" && VIW_ID != null){
//					if(VIW_ID == "013" || VIW_ID == "014" ) {
...
var commonGrid = function(){
	...
	return {
		...
		init: function(flexGrid,cv){
			commonGridInit(flexGrid,cv);
		}
	};
}();	
