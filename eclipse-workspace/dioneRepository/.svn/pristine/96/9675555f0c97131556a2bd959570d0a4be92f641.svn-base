...
/**
 * [KR] 생산성지표 현장사원일일근태등록 컨트롤러<br>
 * 
 * @author $Author$
 * @version $Revision$
 */
@Controller
@RequestMapping(value = "/WAT010StEmpAbsTrd")
@ViewId(value = "WAT010")
public class WAT010StEmpAbsTrdController {
    
    /**
     * [EN] Default constructor.<br>
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAT010StEmpAbsTrdController() {
        // no process
    }
...
//      mv.addObject("authBinaryNum", UxisCmmUtil.getSessionAuthData(request, menu));
        ...
        mv.addObject("url", "StEmpAbsTrd.jsp");
        mv.setViewName(".tiles.page.WAT010");
        return mv;
