...
/**
 * [KR] 중복차종서열코드마스타 컨트롤러<br>
 * 
 * @author $Author$
 * @version $Revision$
 */
@Controller
@RequestMapping(value = "/WAN000DuplTypeOrderCodeMst")
@ViewId(value = "WAN000")
public class WAN000DuplTypeOrderCodeMstController {
    /**
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAN000DuplTypeOrderCodeMstController() {
        // no process
    }
...
//      mv.addObject("authBinaryNum", UxisCmmUtil.getSessionAuthData(request, menu));
        ...
        mv.addObject("url", "DuplTypeOrderCodeMst.jsp");
        mv.setViewName(".tiles.page.WAN000");
        return mv;
