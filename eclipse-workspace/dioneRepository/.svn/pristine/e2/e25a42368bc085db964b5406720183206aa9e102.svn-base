...
/**
 * 
 * @파일명		: SalaryUserServiceImpl.java 
 * @프로젝트	: DNKR
 * @날짜		: 2019. 9. 20. 
 * @작성자		: Cho HeumJun
 * @설명
...
public class SalaryUserServiceImpl implements SalaryUserService {
	 ...
	 */
	@Override
	public Map<String, Object> getSalaryUser(CommandMap commandMap) throws ApplicationException {
		return salaryUserDao.getSalaryUser(commandMap.getMap());
	}
	...
	public List<Map<String, Object>> getFileDataList(String edu_pk) throws ApplicationException {
		return salaryUserDao.getFileDataList(edu_pk);
	}
	 ...
	 */
	@Override
	public Map<String, Object> getSalaryUserInfo(CommandMap commandMap) throws ApplicationException {
		return salaryUserDao.getSalaryUserInfo(commandMap.getMap());
	}
	...
	public List<Map<String, Object>> userQueList(CommandMap commandMap) throws ApplicationException {
		return salaryUserDao.userQueList(commandMap.getMap());
	}
	...
	public List<Map<String, Object>> userAnsList(CommandMap commandMap) throws ApplicationException {
		return salaryUserDao.userAnsList(commandMap.getMap());
	}
	 ...
	 */
	@Override
	public Map<String, String> salaryUserSave(CommandMap commandMap) throws Exception {
		...
		String uploadDir = UxisCmmUtil.getProperty("salaryUser.uploadpath");
		...
		// 등록
		int insertResult = salaryUserDao.setSalaryUserInfoInsert(commandMap.getMap());
		...
		else
		{
			...
			/*if(size > 0) {
				...
				int attachInsertResult = salaryUserDao.salaryUserAttchInsert(commandMap.getMap());
	 ...
	 */
	@Override
	public Map<String, Object> getSalaryAgree(CommandMap commandMap) throws ApplicationException, Exception {
		return salaryUserDao.getSalaryAgree(commandMap.getMap());
	}
	...
	public Map<String, String> agreeConfirm(CommandMap commandMap) throws ApplicationException, Exception {
		...
		int updateResult = salaryUserDao.agreeConfirm(commandMap.getMap());
	...
	@Override
	public Map<String, Object> getSalarySelectList(CommandMap commandMap) throws ApplicationException {
		// 리스트를 취득한다.
		...
		List<Map<String, Object>> listData = salaryUserDao.getSalarySelectList(commandMap.getMap());
