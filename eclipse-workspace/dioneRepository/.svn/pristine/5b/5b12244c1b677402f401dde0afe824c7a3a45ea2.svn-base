 ...
 * PROJECT：
 *
 * [KR] 종합정보-경영정보-진매상OCEAN LIST（가매출
 * 
 * $Id$
 *
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/dwh/WAE014OceanListSalesRevenue.js"></script>
<!-- [EN] Contents area -->
	...
	<form:form>
		<div class="searchCondition">
			...
			<div class="top-bar cb">
				...
				<strong class="pr5">*매월 외상매출금차액 JDE전표생성후 DATA가 생성됩니다.</strong> 	
