...
<form id="noticeRegForm" method="post">
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td><div class="ct">
							<textarea name="content" id="content" rows="10" cols="100" style="width:568px; height:300px; display:none;">${noticeInfo.content}</textarea>
						</div></td> 
					</tr>
				</tbody>
			</table>
