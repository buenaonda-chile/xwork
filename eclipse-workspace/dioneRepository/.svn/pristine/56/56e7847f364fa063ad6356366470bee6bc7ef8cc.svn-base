 ...
 * @version $Revision$
 */
public class WAE031SupplyShippingForm extends SupplyShippingDomain implements Cloneable{
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAE031SupplyShippingForm(){
        super();
    }
     ...
     */
    @Override
    public WAE031SupplyShippingForm clone() {
        WAE031SupplyShippingForm clone = new WAE031SupplyShippingForm();
        try {
