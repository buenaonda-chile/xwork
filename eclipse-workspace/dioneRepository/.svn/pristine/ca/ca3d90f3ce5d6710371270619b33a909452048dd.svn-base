...
<c:url var="readUrl" value="/incidentCost/search"/>
<c:url var="createUrl" value="/incidentCost/create"/>
<c:url var="updateUrl" value="/incidentCost/update"/>
<c:url var="deleteUrl" value="/incidentCost/delete"/>
...
<div class="sub-con-wrap">
    <h2 class="subpage-tit">부대비용관리</h2>
    <!-- 버튼들 -->
    ...
    <fieldset>
      <table>
          ...
          <tr>
                  ...
                  <kendo:dropDownList name="cmb_div_search" dataTextField="codeNm"
                      ...
                      <kendo:dataSource>
                          <kendo:dataSource-transport>
                              <kendo:dataSource-transport-read url="${codeUrl}/CLPART" type="POST" contentType="application/json"/>
              ...
              <th>코드명</th>
              <td>
                  <input type="text" id="itemNm_search" data-bind="value: criteria.itemNm" />
              </td>
              <th>사용여부</th>
              <td>
      ...
      <form id="frm_input" method="post">
        <fieldset>
          <table class="bWrite">
            ...
            <tr>
              <th scope="row"><label for="cmb_div_input">부대비용구분</label>
              </th>
              <td>
            ...
            <tr>
                <th scope="row"><label for="cmb_partDiv_input">부품그룹</label>
                </th>
                <td>
            ...
            <tr>
              <th scope="row"><label for="itemCd_input">코드</label>
              </th>
              <td>
                <input type="text" id="itemCd_input" data-bind="value: data.itemCd" />
              </td>
            </tr>
		
            <tr>
              <th scope="row"><label for="itemNm_input">코드명</label>
              </th>
              <td>
                <input type="text" id="itemNm_input" data-bind="value: data.itemNm" />
              </td>
            </tr>
		
            <tr>
              <th scope="row"><label for="num_value_input">비용</label>
              </th>
              <td>
                  <kendo:numericTextBox name="num_value_input" format="###,###,###,###,###" min="0"
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    cmbDivInput = $("#cmb_div_input", "#frm_input").data("kendoDropDownList");
    var divData = cmbDivInput.dataSource.data(), divItems = _dicasPage.getEditOptions(divData);
	...
	,{ title: '코드', name: 'itemCd', align: 'center' }
	,{ title: '코드명', name: 'itemNm', align: 'center' }
	,{ title: '비용', name: 'value', align: 'center' }
	,{
          title: '사용여부',
          name: 'useYn',
          align: 'center',
