...
/**
 * [KR] 업체부품구성마스타 컨트롤러<br>
 * 
 * @author $Author$
 * @version $Revision$
 */
@Controller
@RequestMapping(value = "/WAN003CustPartConstMst")
@ViewId(value = "WAN003")
public class WAN003CustPartConstMstController {
    /**
     * [KR] 업체부품구성마스타 서비스 <br>     
     */
    @Autowired
     ...
     * [JP] デフォルトコンストラクタ。<br>
     */
    public WAN003CustPartConstMstController() {
        // no process
    }
...
//      mv.addObject("authBinaryNum", UxisCmmUtil.getSessionAuthData(request, menu));
        ...
        mv.addObject("url", "CustPartConstMst.jsp");
        mv.setViewName(".tiles.page.WAN003");
        return mv;
