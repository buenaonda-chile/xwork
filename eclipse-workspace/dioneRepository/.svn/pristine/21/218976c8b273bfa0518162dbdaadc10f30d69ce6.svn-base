...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/dwh/WAE023BusinessShippingMaterial.js"></script>
<!-- [EN] Contents area -->
	...
	<form:form>
		<div class="searchCondition">
			...
			<div class="top-bar cb">
				...
				<strong class="pr5">*매월 제2가동일에  DATA가 생성됩니다.</strong> 	
