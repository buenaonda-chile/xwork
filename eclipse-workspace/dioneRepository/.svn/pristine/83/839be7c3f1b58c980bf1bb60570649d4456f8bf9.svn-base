...
<script language="JavaScript" type="text/javascript">
	...
	function fn_run()
	{
		...
		opener = self;  
		if(sessionCnt > 1){
			location.href = "sessionDisplay2.jsp?EmpNo='"+empNo+"'&Company='"+company+"'&PlantCd='"+plantCd+"'&SessionCnt="+sessionCnt;
			//location.href = "http://10.73.254.21/sessionDisplay2.jsp?EmpNo='"+empNo+"'&Company='"+company+"'&PlantCd='"+plantCd+"'&SessionCnt="+sessionCnt;
		}else{
