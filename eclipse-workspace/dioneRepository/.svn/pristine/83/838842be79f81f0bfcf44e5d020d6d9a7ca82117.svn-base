...
--%>
<c:set var="globalVal" value="${pageContext.session.id}::${sessionScope.userInfo.USER_ID}::${sessionScope.userInfo.USER_NAME}::${sessionScope.userInfo.COMPANY}::${sessionScope.userInfo.PLANT_CD}::${sessionScope.userInfo.PASSWORD}::${sessionScope.userInfo.EMAIL_ID}::${sessionScope.userInfo.LIB1}::${sessionScope.userInfo.LIB2}::${sessionScope.userInfo.LIB3}::${sessionScope.userInfo.LIB4}::${sessionScope.userInfo.LDAPPASS}"/>
...
<title>DIONE</title>
<link rel="stylesheet" href="${cp}/common/css/style/miInstall.css" type="text/css">
<SCRIPT LANGUAGE="JavaScript" src="${cp}/common/js/miInstall.js"></SCRIPT>
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function fnOnLoad() {
		...
		//alert(fnCheckModule()+"===fnCheckModule()");
...
/*
			...
			alert("[알림]최초설치입니다. 화면의 수동설치 문자를 클릭해주세요.");
		}
*/
	}
	...
	function fnCreateIcon() {
		...
		strCommand = "-V 3.2 -D Win32U -R FALSE -K denso -L TRUE ";
		
		MiInstaller.MakeShortCut("%system%MiUpdater321.exe", strCommand, "denso", "%Component%icon128.ico", "desktop");
...
/*
		if(confirm("전용브라우저로 실행하시겠습니까?"))
		{
			...
			window.location = "./Next.asp?Device=U";
		}
*/
...
<table id="ins_tbl" align="center" border=0 width="600">
  <tr>
    <td><table width="637" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td height="37" bgcolor="#EEEEEE"> <table width="607" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td><table width="607" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="12" height="12"><img src="${cp}/ui/image/miInstall/insu_down_listbg_sub1.gif" width="12" height="12"></td>
                      <td width="583" height="12" bgcolor="#FFFFFF"></td>
                      <td width="12" height="12"><img src="${cp}/ui/image/miInstall/insu_down_listbg_sub2.gif" width="12" height="12"></td>
                    </tr>
                    <tr> 
                      ...
                      <td bgcolor="#FFFFFF">
						...
						<tr>
                            <td width="10" valign="top"><img src="${cp}/ui/image/miInstall/insu_down_list_icon1.gif" width="8" height="11"></td>
                    ...
                    <tr> 
                      ...
                      <table width="570" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr> 
                            ...
                            <img src="${cp}/ui/image/miInstall/insu_down_list_icon1.gif" width="8" height="11">
                            </td>
                            <td width="570">윈도우 XP 서비스팩2 사용자께서는 주소 표시줄 아래 경고문구  
                            “ <img src="${cp}/ui/image/miInstall/insu_down_list_icon2.gif" width="15" height="15" align="absmiddle">
                    ...
                    <tr> 
					  <td bgcolor="#FFFFFF">
						<table width="570" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <strong><font color="#FF7200"><a href="${cp}/miInstallU/MiPlatform_SetupUpdater321.exe">수동설치</a></font></strong>를 통해 수동설치하시거나 
                    ...
                    <tr> 
                      <td width="12" height="12"><img src="${cp}/ui/image/miInstall/insu_down_listbg_sub3.gif" width="12" height="12"></td>
                      <td bgcolor="#FFFFFF"></td>
                      <td width="12" height="12"><img src="${cp}/ui/image/miInstall/insu_down_listbg_sub4.gif" width="12" height="12"></td>
                    </tr>
                  </table></td>
              </tr>
            </table></td>
        ...
        <tr> 
          <td><img src="${cp}/ui/image/miInstall/insu_down_listbg2.gif" width="637" height="11"></td>
        </tr>
        <tr>
          <td height="5"></td>
        </tr>
