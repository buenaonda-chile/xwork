...
<c:url var="popupUrl4" value="/researchSD/init"/>
...
<form id="frm_search" method="get">
  <div class="sub-con-wrap">
    <h2 class="subpage-tit">클레임 접수(SD)</h2>
    <!-- 버튼들 -->
    ...
    <form id="frm_input" method="post">
      <table class="bWrite">
        ...
        <tr>
          ...
          <td><input type="text" id="mechanic1Nm_input" data-bind="value: data.mechanic1Nm"/><input type="text" id="mechanic1Tel_input" data-bind="value: data.mechanic1Tel"/></td>
          <th>보증</th>
          <td>
    ...
    <div class="layout-B">
      ...
      <table class="bWrite">
        ...
        <tr>
          ...
          <th rowspan="2" class="no_ic">정비소점검 /<br/>상담내용</th>
          <td rowspan="2">
...
<script type="text/javascript">
    ...
    function inputView3Enabled() {
        ...
        //dropdownlist.readonly(false);
        var dropdownlist = $("#cmb_maker_input").data("kendoDropDownList");
        dropdownlist.readonly(false);
    ...
    $(document).ready(function () {
        ...
        var dtcData = new kendo.data.DataSource({data: ${dtcItems}}),
