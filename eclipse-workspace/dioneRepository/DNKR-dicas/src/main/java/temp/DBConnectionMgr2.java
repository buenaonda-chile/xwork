...
public class DBConnectionMgr2 {
    ...
    private Vector connections = new Vector(40);
    ...
    public static DBConnectionMgr2 getInstance() {
        ...
        if (instance == null) { //생성되어 있지 않다면
            ...
            synchronized (DBConnectionMgr2.class) {//Lock 설정

                if (instance == null) {//수영장이 없으면

                    instance = new DBConnectionMgr2();//수영장 생성
...
//    }
    ...
    public synchronized Connection getConnection()
        ...
        if (!initialized) {
            ...
            Class c = Class.forName(TempConst2._DRIVER);
...
//                System.out.println("co.connection:" + co.connection);
        ...
        for (int i = 0; i < connections.size(); i++) {
            ...
            if ((i + 1) > TempConst2._OPENCONNECTIONS && !co.inUse)
    ...
    private Connection createConnection() throws SQLException {
        ...
        try {
            ...
            //if (BatchConst._USER == null) BatchConst._USER = "";

            //if (BatchConst._PASSWORD == null) BatchConst._PASSWORD = "";

            Properties props = new Properties();

            props.put("user", TempConst2._USER);

            props.put("password", TempConst2._PASSWORD);
            ...
            con = DriverManager.getConnection(TempConst2._URL, props);
