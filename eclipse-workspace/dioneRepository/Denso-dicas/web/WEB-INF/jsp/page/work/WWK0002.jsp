...
<c:url var="readUrl" value="/research/search"/>
...
<div class="popup_container">
    <form id="frm_search" method="get" >
        <div class="sub-con-wrap">
            <h2 class="subpage-tit">클레임 조사</h2>
            ...
            <form id="frm_input2" method="post">
                ...
                <table class="bWrite">
                    ...
                    <tr>
                        ...
                        <th>고품요청일</th>
                        <td>
                            <input type="text" id="recallReqDate_input" data-bind="value: data.recallReqDate"  class="calendar" />
                        </td>
                        <th>고품송부일</th>
                        <td>
                        ...
                        <th>고품회수일</th>
                        <td>
                            <input type="text" id="receiveDate_input" data-bind="value: data.receiveDate"  class="calendar" />
                            <span class="help_wrap">
              <a href="#help_txt_1" class="b1 toggle"><i onmouseover="highlight(this)" onmouseout="unhighlight(this)" class="ic_help"></i></a>
              <span class="help_txt" id="help_txt_1"><em>미회수의 경우, 1999.99.99 입력</em></span>
            </span>
                        </td>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <th>제번</th>
                        <td>
                            <input type="text" id="removeNo_input" data-bind="value: data.removeNo" />
                        </td>
                        <th>수리일</th>
                        <td>
                        ...
                        <th>확정일</th>
                        <td>
                            <input type="text" id="roConfirmDate_input" data-bind="value: data.roConfirmDate"  class="calendar" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <th>CS/RS</th>
                        <td>
                            <kendo:dropDownList name="recallType_input" dataTextField="codeNm"
                                                dataValueField="codeCd"
                                                data-value-primitive="true"
                                                data-bind="value: data.recallType" >
                                <kendo:dataSource data="${recallTypeItems}"/>
                            </kendo:dropDownList>
                        </td>
                        <th>GQNET NO</th>
                        <td>
                    ...
                    <tr>
                        <th>1차결과</th>
                        <td>
                            <kendo:dropDownList name="cmb_fieldWorkResult_input" dataTextField="codeNm"
                                                dataValueField="codeCd"
                                                data-value-primitive="true"
                                                data-bind="value: data.fieldWorkResult" >
                                <kendo:dataSource data="${fieldWorkResultItems}"/>
                            </kendo:dropDownList>
                            <%--<input type="text" id="fieldWorkResult_input" data-bind="value: data.fieldWorkResult" />--%>
                        </td>
                        <th>최종결과</th>
                        <td>
                            <kendo:dropDownList name="cmb_finalResearchResult_input" dataTextField="codeNm"
                                                dataValueField="codeCd"
                                                data-value-primitive="true"
                                                data-bind="value: data.finalResearchResult" >
                                <kendo:dataSource data="${finalResearchResultItems}"/>
                            </kendo:dropDownList>
                            <%--<input type="text" id="finalResearchResult_input" data-bind="value: data.finalResearchResult" />--%>
                        </td>
                        <th>품질문제명</th>
                        <td>
                            <kendo:dropDownList name="cmb_qualityProblemNm_input" dataTextField="qualityProblemNm"
                                                dataValueField="qualityProblemNm"
                                                data-value-primitive="true"
                                                data-bind="value: data.qualityProblemNm"
                                                optionLabel=" "
                                                autoWidth="true" style="width:300px">
    ...
    var buttonView = kendo.observable({
        add: function() {
            ...
            */
            ...
            //결과항목 그리드set
            grid.setValue(gridRowkey, "roNo", inputView2.data.roNo);
            grid.setValue(gridRowkey, "recallReqDate", inputView2.data.recallReqDate);
            grid.setValue(gridRowkey, "gqnetIssueDate", inputView2.data.gqnetIssueDate);
            grid.setValue(gridRowkey, "receiveDate", inputView2.data.receiveDate);
            grid.setValue(gridRowkey, "enginNo", inputView2.data.enginNo);
            grid.setValue(gridRowkey, "removeNo", inputView2.data.removeNo);
            grid.setValue(gridRowkey, "repairDate", inputView2.data.repairDate);
            grid.setValue(gridRowkey, "repairDate", inputView2.data.repairDate);
            grid.setValue(gridRowkey, "roConfirmDate", inputView2.data.roConfirmDate);
            grid.setValue(gridRowkey, "actionType", inputView2.data.actionType);
            grid.setValue(gridRowkey, "matDiv", inputView2.data.matDiv);
            grid.setValue(gridRowkey, "recallType", inputView2.data.recallType);
            grid.setValue(gridRowkey, "gqnetNo", inputView2.data.gqnetNo);
            grid.setValue(gridRowkey, "fieldWorkResult", inputView2.data.fieldWorkResult);
            grid.setValue(gridRowkey, "finalResearchResult", inputView2.data.finalResearchResult);
            grid.setValue(gridRowkey, "qualityProblemNm", inputView2.data.qualityProblemNm);
            grid.setValue(gridRowkey, "totalAmt", inputView2.data.totalAmt);
            grid.setValue(gridRowkey, "totalVal", inputView2.data.totalVal);
            grid.setValue(gridRowkey, "partVal", inputView2.data.partVal);
            grid.setValue(gridRowkey, "laborVal", inputView2.data.laborVal);
            grid.setValue(gridRowkey, "etcVal", inputView2.data.etcVal);
            grid.setValue(gridRowkey, "roSpecialFeature", inputView2.data.roSpecialFeature);
