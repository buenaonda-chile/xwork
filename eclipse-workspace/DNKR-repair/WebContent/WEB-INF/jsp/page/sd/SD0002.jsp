...
<c:url var="initUrl" value="/returnSDBrkPart/init"/>

<c:url var="readUrl" value="/returnSDBrkPart/search"/>

<c:url var="createUrl" value="/returnSDBrkPart/create"/>

<c:url var="updateUrl" value="/returnSDBrkPart/update"/>

<c:url var="deleteUrl" value="/returnSDBrkPart/delete"/>

<c:url var="downloadUrl" value="/returnSDBrkPart/download"/>
