...
<c:url var="initUrl" value="/receiptRepairReplacement/init"/>

<c:url var="readUrl" value="/receiptRepairReplacement/search"/>

<c:url var="createUrl" value="/receiptRepairReplacement/create"/>

<c:url var="updateUrl" value="/receiptRepairReplacement/update"/>

<c:url var="deleteUrl" value="/receiptRepairReplacement/delete"/>
...
<div class="sub-con-wrap">
  <h2 class="subpage-tit">수리대체품접수관리</h2>
  <!-- 버튼들 -->
      ...
      <table>
       <colgroup>
        ...
        <tr>
          ...
          <th style="width:100px;">수리대체품번호</th>
          <td>
