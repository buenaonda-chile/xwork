...
<c:url var="initUrl" value="/receiptCDRepairItemAdmiss/init"/>

<c:url var="readUrl" value="/receiptCDRepairItemAdmiss/search"/>

<c:url var="updateUrl" value="/receiptCDRepairItemAdmiss/update"/>
...
<div class="sub-con-wrap">
  <h2 class="subpage-tit">수리품접수승인</h2>
  <!-- 버튼들 -->
