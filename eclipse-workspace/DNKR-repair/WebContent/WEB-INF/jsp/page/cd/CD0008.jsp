...
<c:url var="initUrl" value="/orderCDRepairItemAdmiss/init"/>

<c:url var="readUrl" value="/orderCDRepairItemAdmiss/search"/>

<c:url var="updateUrl" value="/orderCDRepairItemAdmiss/update"/>
...
<div class="sub-con-wrap">
  <h2 class="subpage-tit">수리품발주승인</h2>
  <!-- 버튼들 -->
