...
<c:url var="initUrl" value="/orderDNKRRepairPartAdmiss/init"/>

<c:url var="readUrl" value="/orderDNKRRepairPartAdmiss/search"/>

<c:url var="updateUrl" value="/orderDNKRRepairPartAdmiss/update"/>
...
<div class="sub-con-wrap">
  <h2 class="subpage-tit">수리부품발주승인</h2>
  <!-- 버튼들 -->
