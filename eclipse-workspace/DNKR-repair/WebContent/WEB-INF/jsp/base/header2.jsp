...
<%-- mainNav-wrap --%>
<div id="mainNav-wrap">
  <h1 id="logo"><a href="" title="메인"><img src="<c:url value="/assets/img/logo.png"/>" alt="로고"></a></h1>
  <p class="menu-bnt"><a href="javascript:void(0);"><img src="<c:url value="/assets/img/menu-bnt.png"/>" align="전체메뉴버튼"></a></p>
  <div class="gap20"></div>
  <%-- mainNav --%>
  <div id="mainNav">
    <tiles:insertTemplate template="/WEB-INF/jsp/base/menu2.jsp" />
    <div class="gap20"></div>
    <div class="mNav-ctrl">
  ...
  <%--// mainNav --%>
  <div class="home"><a href=""><img src="<c:url value="/assets/img/home.png"/>" alt="홈버튼"></a></div>
</div>
<%--// mainNav-wrap --%>