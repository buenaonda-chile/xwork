...
var save = function(){
	...
	for ( var i = 0; i <cv.itemsEdited.length; i ++) {
		...
		ajaxCommit("/orderDNKRRepairPartAdmiss/update",cv.itemsEdited[i]);
	}
...
var search = function(){
	...
	var url = '/orderDNKRRepairPartAdmiss/search';
	
	var params = {
		"searchOrdDtFr" : wijmo.Globalize.format(sdat.value,'yyyyMMdd'),
		"searchOrdDtTo" : wijmo.Globalize.format(edat.value,'yyyyMMdd'),
...
var gridInit = function() {
	...
	columnsDefinition = [
        ...
        {binding: 'orderDt', header: '발주일자', width: '*', align:'center',dataType:'String',editor: dat,isReadOnly:true}, //wordWrap: true: 텍스트 자동줄바꿈 autorowHeights랑 같이 사용
		...
		{binding: 'custId', header: '발주처아이디', width: '*', align:'center',dataType:'Number',visible:false},
