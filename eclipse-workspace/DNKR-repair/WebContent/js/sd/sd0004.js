...
var save = function(){
	...
	for ( var i = 0; i <cv.itemsAdded.length; i ++) {
		...
		ajaxCommit("/receiptSDRepairItem/create",cv.itemsAdded[i]);
	...
	for ( var i = 0; i <cv.itemsEdited.length; i ++) {
		...
		ajaxCommit("/receiptSDRepairItem/update",cv.itemsEdited[i]);
	}
	...
	for ( var i = 0; i <cv.itemsRemoved.length; i ++) {
		...
		ajaxCommit("/receiptSDRepairItem/delete",cv.itemsRemoved[i]);
...
var search = function(){
	...
	var url = '/receiptSDRepairItem/search';
...
var gridInit = function() {
	...
	columnsDefinition = [
        ...
        {binding: 'rectDt', header: '접수일자', width: '*', align:'center',dataType:'String',maxLength:12}, //wordWrap: true: 텍스트 자동줄바꿈 autorowHeights랑 같이 사용
