...
var save = function(){
	...
	for ( var i = 0; i <cv.itemsAdded.length; i ++) {
		...
		ajaxCommit("/orderCDRepairPart/create",cv.itemsAdded[i]);
	...
	for ( var i = 0; i <cv.itemsEdited.length; i ++) {
		...
		ajaxCommit("/orderCDRepairPart/update",cv.itemsEdited[i]);
	}
	...
	for ( var i = 0; i <cv.itemsRemoved.length; i ++) {
		...
		ajaxCommit("/orderCDRepairPart/delete",cv.itemsRemoved[i]);
...
var search = function(){
	...
	var url = '/orderCDRepairPart/search';
