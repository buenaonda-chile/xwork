...
var sdat = new wijmo.input.InputDate("#searchDelDtFr");	//출하일자 시작
		
var edat = new wijmo.input.InputDate("#searchDelDtTo");	//출하일자 종료

var dat = new wijmo.input.InputDate(document.createElement('div')); //출하일자
...
var save = function(){
	...
	for ( var i = 0; i <cv.itemsAdded.length; i ++) {
		...
		ajaxCommit("/deliveryCDRepairItem/create",cv.itemsAdded[i]);
	...
	for ( var i = 0; i <cv.itemsEdited.length; i ++) {
		...
		ajaxCommit("/deliveryCDRepairItem/update",cv.itemsEdited[i]);
	}
	...
	for ( var i = 0; i <cv.itemsRemoved.length; i ++) {
		...
		ajaxCommit("/deliveryCDRepairItem/delete",cv.itemsRemoved[i]);
...
var search = function(){
	...
	var url = '/deliveryCDRepairItem/search';
	
	var params = {
		"searchDelDtFr" : wijmo.Globalize.format(sdat.value,'yyyy-MM-dd'),
		"searchDelDtTo" : wijmo.Globalize.format(edat.value,'yyyy-MM-dd'),
		"delvNo" : $("#delvNo").val(),
		"partNo" : $("#partNo").val(),
		"custNm" : $("#custNm").val(),
		"page":1
