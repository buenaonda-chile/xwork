...
<c:url var="readUrl" value="/partName/search"/>
<c:url var="createUrl" value="/partName/create"/>
<c:url var="updateUrl" value="/partName/update"/>
<c:url var="deleteUrl" value="/partName/delete"/>
...
<div class="sub-con-wrap">
  <h2 class="subpage-tit">교환품명관리</h2>
  <!-- 버튼들 -->
      ...
      <form id="frm_input" method="post">
        ...
        <fieldset>
          <table class="bWrite">
            ...
            <tr>
              <th scope="row"><label for="exchangeNm_input">부품명<em class="required" title="필수항목">*</em></label>
              </th>
              <td>
                <input type="text" id="exchangeNm_input" data-bind="value: data.exchangeNm" required />
              </td>
            </tr>
		    <tr>
              <th scope="row">
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    var makerData = cmbMakerInput.dataSource.data(), cmbMakerItems = _dicasPage.getEditOptions(makerData);
