...
<%-- [JP] 変数定義 --%>
<c:url var="readUrl" value="/popup/group/search"/>
            ...
            <fieldset>
                <table>
                    ...
                    <tr>
                        <th>부서명</th>
                        <td>
                            <input type="text" id="text_deptNmKr" data-bind="value: criteria.deptNmKr" />
                        </td>
                        <td>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        // searchView.set('criteria.upDeptCd', _dicasPage.getParameterByName("codeVal"));
