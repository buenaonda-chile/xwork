...
<c:url var="initUrl" value="/deliveryRepairItem/init"/>

<c:url var="readUrl" value="/deliveryRepairItem/search"/>

<c:url var="createUrl" value="/deliveryRepairItem/create"/>

<c:url var="updateUrl" value="/deliveryRepairItem/update"/>

<c:url var="deleteUrl" value="/deliveryRepairItem/delete"/>
    ...
    <fieldset>
      <table>
        ...
        <tr>
          <th>출하번호</th>
          <td>
          	<input type="text" name="delvNo" id="delvNo" style="width:100px; height:35px;">
          </td>
          <th>수리품번호</th>
          <td>
          ...
          <th>출하일자</th>
          <td>
          	<input id="searchDelDtFr"> ~ <input id="searchDelDtTo">
          </td>
        </tr>
      </table>
    </fieldset>
