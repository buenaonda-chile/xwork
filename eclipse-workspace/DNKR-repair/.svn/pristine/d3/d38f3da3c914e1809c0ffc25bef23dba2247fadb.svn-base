...
public class MainController {
   ...
   * @throws Exception Exception
   */
  @RequestMapping(method = RequestMethod.GET, value = "/mainTraining")
  @ViewId(value = "WCM0002")
  public ModelAndView init2(HttpServletRequest request) throws Exception {
	  
    ModelAndView mv = new ModelAndView();
    mv.setViewName(".tiles.page.main2");
