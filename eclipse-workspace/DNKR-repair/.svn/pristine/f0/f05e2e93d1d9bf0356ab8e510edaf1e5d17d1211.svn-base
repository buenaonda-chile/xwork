...
<c:url var="initUrl" value="/orderCDRepairPart/init"/>

<c:url var="readUrl" value="/orderCDRepairPart/search"/>

<c:url var="createUrl" value="/orderCDRepairPart/create"/>

<c:url var="updateUrl" value="/orderCDRepairPart/update"/>

<c:url var="deleteUrl" value="/orderCDRepairPart/delete"/>
...
<div class="sub-con-wrap">
  <h2 class="subpage-tit">수리대체품발주관리</h2>
  <!-- 버튼들 -->
