...
<c:url var="initUrl" value="/itemPopUp/init"/>

<c:url var="readUrl" value="/itemPopUp/search"/>
  ...
  <form id="frm_search" method="get" >
    <fieldset>
      <table style="width:800px;">
        ...
        <tr>
          <th style="width:10px;">품목명</th>
          <td>
          	<input type="text" style="width:100px; height:35px;" name="itemNm" id="itemNm">
          </td>
          <th style="width:10px;">품목명</th>
          <td>
          	<input type="text" style="width:100px; height:35px;" name="partNo" id="partNo">
          </td>
        </tr>
      </table>
    </fieldset>
