...
<c:url var="initUrl" value="/receiptCDBrkPartAdmiss/init"/>

<c:url var="readUrl" value="/receiptCDBrkPartAdmiss/search"/>

<c:url var="updateUrl" value="/receiptCDBrkPartAdmiss/update"/>
...
<div class="sub-con-wrap">
  <h2 class="subpage-tit">고품접수승인</h2>
  <!-- 버튼들 -->
