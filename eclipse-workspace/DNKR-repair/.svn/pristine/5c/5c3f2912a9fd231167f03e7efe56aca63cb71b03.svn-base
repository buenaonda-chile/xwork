...
var edat = new wijmo.input.InputDate("#searchOrdDtTo");	//빌즈일자 종료
...
var save = function(){
	...
	for ( var i = 0; i <cv.itemsEdited.length; i ++) {
		...
		ajaxCommit("/orderCDRepairItemAdmiss/update",cv.itemsEdited[i]);
	}
...
var search = function(){
	...
	var url = '/orderCDRepairItemAdmiss/search';
