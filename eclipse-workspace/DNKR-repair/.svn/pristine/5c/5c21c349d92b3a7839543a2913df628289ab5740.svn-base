...
//    }
    ...
    public synchronized Connection getConnection()
        ...
        if (!initialized) {
            ...
            Class c = Class.forName(TempConst._DRIVER);
...
//                System.out.println("co.connection:" + co.connection);
        ...
        for (int i = 0; i < connections.size(); i++) {
            ...
            if ((i + 1) > TempConst._OPENCONNECTIONS && !co.inUse)
    ...
    private Connection createConnection() throws SQLException {
        ...
        try {
            ...
            props.put("user", TempConst._USER);

            props.put("password", TempConst._PASSWORD);
            ...
            con = DriverManager.getConnection(TempConst._URL, props);
