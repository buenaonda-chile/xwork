...
@Controller
@RequestMapping(value = "/kpiManagementDNKR")
public class KPIManagementDNKRController {

  private static final Logger LOGGER = LoggerFactory.getLogger(KPIManagementDNKRController.class);

  @Autowired
  private KPIManagementDNKRService kpiManagementDNKRService;
   ...
   * [JP] ?????????????<br>
   */
  public KPIManagementDNKRController() {
    // no process
  }
  ...
  public ModelAndView init(HttpServletRequest request,
	  ...
	  mv.setViewName(".tiles.page.dnkr.DNKR0007");
  ...
  public ModelAndView search(KPIManagementDNKRSearchForm criteria, Pageable pageable) throws Exception {

	Page<KPIManagementDNKRDto> KPIManagementDNKRs = kpiManagementDNKRService.searchByCondition(criteria, pageable);  
    ...
    pageMap.put("totalCount", KPIManagementDNKRs.getTotalElements());

    retMap.put("contents", KPIManagementDNKRs.getContent());
