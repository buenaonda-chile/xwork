...
<c:url var="initUrl" value="/saleSDRepiarItem/init"/>

<c:url var="readUrl" value="/saleSDRepiarItem/search"/>

<c:url var="createUrl" value="/saleSDRepiarItem/create"/>

<c:url var="updateUrl" value="/saleSDRepiarItem/update"/>

<c:url var="deleteUrl" value="/saleSDRepiarItem/delete"/>
...
<div class="sub-con-wrap">
  <h2 class="subpage-tit">수리정보관리</h2>
  <!-- 버튼들 -->
    ...
    <fieldset>
      <table>
        ...
        <tr>
          <th>수리번호</th>
          <td>
          	<input type="text" name="repNo" id="repNo" style="width:100px; height:35px;">
          </td>
          <th>수리상태</th>
          <td>
          ...
          <th>불량타입</th>
          <td>
          	<div id="ngType" style="width:100px; height:35px;"></div>
          </td>
          <th>수리일자</th>
          <td>
