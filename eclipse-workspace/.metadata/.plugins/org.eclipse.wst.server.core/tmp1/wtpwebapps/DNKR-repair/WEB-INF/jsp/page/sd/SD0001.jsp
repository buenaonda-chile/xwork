...
<c:url var="initUrl" value="/receiptSDBrkPart/init"/>

<c:url var="readUrl" value="/receiptSDBrkPart/search"/>

<c:url var="createUrl" value="/receiptSDBrkPart/create"/>

<c:url var="updateUrl" value="/receiptSDBrkPart/update"/>

<c:url var="deleteUrl" value="/receiptSDBrkPart/delete"/>

<c:url var="downloadUrl" value="/receiptSDBrkPart/download"/>
