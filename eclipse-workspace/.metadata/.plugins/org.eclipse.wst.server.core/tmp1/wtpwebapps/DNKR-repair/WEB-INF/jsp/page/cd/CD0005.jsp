...
<c:url var="initUrl" value="/receiptCDRepairPart/init"/>

<c:url var="readUrl" value="/receiptCDRepairPart/search"/>

<c:url var="createUrl" value="/receiptCDRepairPart/create"/>

<c:url var="updateUrl" value="/receiptCDRepairPart/update"/>

<c:url var="deleteUrl" value="/receiptCDRepairPart/delete"/>
    ...
    <fieldset>
      <table>
        ...
        <tr>
          ...
          <th>접수일자</th>
          <td>
          	<input id="searchDisDtFr"> ~ <input id="searchDisDtTo">
          </td>
        </tr>
      </table>
    </fieldset>
