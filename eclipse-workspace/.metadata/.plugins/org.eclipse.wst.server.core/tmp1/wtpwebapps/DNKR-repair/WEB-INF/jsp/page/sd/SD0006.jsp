    ...
    <fieldset>
      <table>
        ...
        <tr>
          <th>판매번호</th>
          <td>
          	<input type="text" name="saleNo" id="saleNo" style="width:100px; height:35px;">
          </td>
          <th>수리품번호</th>
          <td>
          ...
          <th>판매일자</th>
          <td>
          	<input id="searchSalDtFr"> ~ <input id="searchSalDtTo">
          </td>
        </tr>
      </table>
    </fieldset>
