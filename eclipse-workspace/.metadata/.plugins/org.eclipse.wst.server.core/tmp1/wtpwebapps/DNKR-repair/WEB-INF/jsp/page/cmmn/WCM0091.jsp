...
<c:url var="readUrl" value="/engineType/search"/>
<c:url var="createUrl" value="/engineType/create"/>
<c:url var="updateUrl" value="/engineType/update"/>
<c:url var="deleteUrl" value="/engineType/delete"/>
...
<div class="sub-con-wrap">
  <h2 class="subpage-tit">엔진형식관리</h2>
  <!-- 버튼들 -->
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
      ...
      var tireStdData = cmbTireStdInput.dataSource.data(), tireStdItems = _dicasPage.getEditOptions(tireStdData);
