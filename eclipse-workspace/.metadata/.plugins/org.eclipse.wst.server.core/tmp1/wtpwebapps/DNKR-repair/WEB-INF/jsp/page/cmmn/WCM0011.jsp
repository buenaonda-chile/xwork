...
<c:url var="readUrl" value="/mainCategory/search"/>
<c:url var="createUrl" value="/mainCategory/create"/>
<c:url var="updateUrl" value="/mainCategory/update"/>
<c:url var="deleteUrl" value="/mainCategory/delete"/>
...
<div class="sub-con-wrap">
  <h2 class="subpage-tit">현상관리 대</h2>
  <!-- 버튼들 -->
      ...
      <form id="frm_input" method="post">
        ...
        <fieldset>
          <table class="bWrite">
            ...
            <tbody>
            <tr>
              <th scope="row"><label for="mainCategory_input">대분류코드</label>
              </th>
              <td>
                <input type="text" id="mainCategory_input" data-bind="value: data.mainCategory" />
              </td>
            </tr>
            ...
            <tr>
              <th scope="row"><label for="mainCategoryNm_input">대분류명</label>
              </th>
              <td>
                <input type="text" id="mainCategoryNm_input" data-bind="value: data.mainCategoryNm" />
              </td>
            </tr>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
	...
	,{ title: '대분류코드', name: 'mainCategory', align: 'center' }
	...
	,{ title: '대분류명', name: 'mainCategoryNm', align: 'center' }
