...
var save = function(){
	...
	for ( var i = 0; i <cv.itemsEdited.length; i ++) {
		...
		ajaxCommit("/receiptDNKRRepairPartAdmiss/update",cv.itemsEdited[i]);
	}
...
var search = function(){
	...
	var url = '/receiptDNKRRepairPartAdmiss/search';
	
	var params = {
		"searchRecDtFr" : wijmo.Globalize.format(sdat.value,'yyyyMMdd'),
		"searchRecDtTo" : wijmo.Globalize.format(edat.value,'yyyyMMdd'),
