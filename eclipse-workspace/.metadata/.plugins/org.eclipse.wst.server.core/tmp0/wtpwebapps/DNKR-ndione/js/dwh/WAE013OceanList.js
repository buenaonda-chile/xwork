...
function createGrid(){
	unitGrid = new ax5.ui.grid({
      ...
      columns: [
          ...
          {key: "jpsam", label: "금액", formatter: function() {return ax5.util.number(this.item.jpsam, {"money": 1});}, align: "right"},
...
/*		  {key: "mnfcs", label: "MFG.COST",  formatter: function() {return ax5.util.number(this.item.mnfcs);}, align: "right"},
*/
          ...
          {key: "dirmc", label: "DIR.MAT.COST",  formatter: function() {return ax5.util.number(this.item.dirmc, {"money": 1});}, align: "right"},
          ...
          {key: "mohcs", label: "MFG.OVERHEAD", foformatter: function() {return ax5.util.number(this.item.mohcs, {"money": 1});}, align: "right"}
      ]
	});
