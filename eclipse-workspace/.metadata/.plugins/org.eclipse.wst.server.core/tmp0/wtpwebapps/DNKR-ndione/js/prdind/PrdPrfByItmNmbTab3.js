...
var cv3 = new wijmo.collections.CollectionView(null);	//컬랙션뷰 전역변수
var flexGrid3 = new wijmo.grid.FlexGrid('#wijmoGrid3');	//그리드 전역변수
...
function search3(){
	...
	var url = "/ajaxPrdPrfByItmNmb/search3.do";	
	var params = {
...
function downloadExcel3(){
	...
	var fileName = "정미공수기준시간_"+getToday()+".xlsx";
	
	wijmo.grid.xlsx.FlexGridXlsxConverter.saveAsync(flexGrid3, 
...
//	flexGridFilter.filterColumns = ['lineCode'];
	flexGrid3.allowSorting = false;	
//	flexGrid3.columnHeaders.rows.defaultSize = 80; 	// 열 헤더 영역에 행의 높이 설정		
}
