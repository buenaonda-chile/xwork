...
function search() {
	...
	if (val_chk(pJobFileName, "작업파일")) {
		...
		var objList = getAjaxList("/WAE029MaterialWasteSearch/ajaxSearch.do", params)
	}
	return false;
}
...
function createGrid(){
	unitGrid = new ax5.ui.grid({
        ...
        columns: [
            ...
            {key: "badqy", label: "불량수량", formatter: "money", align: "right"},
...
//	=== grid =================================================
	...
	$('.exel').on('click', function() {
		unitGrid.exportExcel("월폐기현황.xls");
	});
//	=== //grid =================================================
