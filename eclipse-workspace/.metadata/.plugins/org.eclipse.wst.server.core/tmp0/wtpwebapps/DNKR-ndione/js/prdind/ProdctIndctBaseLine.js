...
//	var comsBase = new DataMap(coms_base, 'id', 'name');
	var columnsDefinition=[
		...
		{binding:'lineCode',header: '* '+ LB_LINE_CODE,width: 150, align:'center',dataType:'String', maxLength:4},
		{binding:'lineNm',header: '* '+ LB_LINE_NAME, width: 180, align:'center',dataType:'String', maxLength:50},
		{ header: '* 부서(반)', align: 'center',  columns: [
			{binding:'locCode',header: '* '+ LB_CODE,width: 100, align:'center',dataType:'String', maxLength:4},
			{binding:'locNm',header: '* '+ LB_NAME,width: 210, align:'center',dataType:'String', maxLength:50,isReadOnly: true},
		]},
		{ header: '* 부서(Part)', align: 'center',  columns: [
			{binding:'partCode',header: '* '+ LB_CODE,width: 100, align:'center',dataType:'String', maxLength:4},
			{binding:'partNm',header: '* '+ LB_NAME,width: 130, align:'center',dataType:'String', maxLength:50,isReadOnly: true},
		]},		
	    {binding:"workStle",header: '* '+ LB_WORK_STLE,width: 90, align:'center',dataType:'String', maxLength:2},
   		{ header: '* 제품1', align: 'center',  columns: [	
			{binding:"prdtCode1",header: '* '+ LB_CODE,width: 100, align:'center',dataType:'String', maxLength:1},
	    	{binding:"prdtNm1",header: '* '+ LB_NAME,width: 150, align:'center',dataType:'String', maxLength:50,isReadOnly: true}
		]},
   		{ header: '* 제품2', align: 'center',  columns: [			
	    	{binding:"prdtCode2",header:LB_CODE,width: 100, align:'center',dataType:'String', maxLength:1},
	    	{binding:"prdtNm2",header:LB_NAME,width: 150, align:'center',dataType:'String', maxLength:50,isReadOnly: true}
		]},
   		{ header: '* 제품3', align: 'center',  columns: [				
	    	{binding:"prdtCode3",header:LB_CODE,width: 100, align:'center',dataType:'String', maxLength:1},
	    	{binding:"prdtNm3",header:LB_NAME,width: 150, align:'center',dataType:'String', maxLength:50,isReadOnly: true}
		]},
	    {binding:"ifCode",header: '* '+ LB_IF_CODE,width: 100, align:'center',dataType:'String', maxLength:5},
	    {binding:"ifType",header: '* '+ LB_IF_TYPE,width: 100, align:'center',dataType:'String', maxLength:1, dataMap: ifTypeMap}
	];	
	//컬럼 초기화
	flexGrid.initialize({
