		...
		<div style="margin: 0px 15px 0px 0px;">
			<div class="k_cg1" style="text-align: center">
				<div class="k_sg1 gridBtnBlock" style="text-align: center">
					...
					<!-- 라인코드 -->
					<div class="inlineBlock schLine">
						<label class="k_l1"><spring:message code='label.WAT001.part'/></label>	
						<input type="text" class="AXInput getCusnm" style="width : 60px;" name="getPartId" id="getPartId"  maxlength="8">
					</div>	
				</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/prdind/PrdPrfByLoc.js?ver=1.124"></script>