		...
		<div style="margin: 0px 15px 0px 0px;">
			<div class="k_cg1" style="text-align: center">
				<div class="k_sg1 gridBtnBlock" style="text-align: center">
					...
					<label class="k_l1">품번조회</label>
					<input type="text" class="AXInput getPyvnd" style="width : 130px;" name="getItemCode" id="getItemCode" >
					<label class="k_l1">품명조회</label>
					<input type="text" class="AXInput getPyvnd" style="width : 250px;" name="getItemNm" id="getItemNm">						
