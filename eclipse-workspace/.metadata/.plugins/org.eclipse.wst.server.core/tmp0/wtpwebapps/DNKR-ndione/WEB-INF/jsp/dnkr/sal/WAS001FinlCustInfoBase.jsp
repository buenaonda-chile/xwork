...
var LB_ADD_ROW = "<spring:message code='label.WAS001.addrow'/>";
var LB_ERROR_ALT = "<spring:message code='label.WAS000.errAlert'/>";
var LB_INSERT_CHK1 = "<spring:message code='label.WAS006.insChk1'/>";
var LB_INSERT_CHK2 = "<spring:message code='label.WAS001.insChk1'/>";
var LB_INSERT_CHK3 = "<spring:message code='label.WAS001.insChk2'/>";
...
var LN_FILE_NM = "<spring:message code='label.WAS001.fileNm'/>";
		...
		<div style="margin: 0px 15px 0px 0px;">
			<div class="k_cg1" style="text-align: center">
				<div class="k_sg1 gridBtnBlock" style="text-align: center">
					<!-- 
					<label class="k_l1"><spring:message code='label.WAS001.comps'/></label>			
					<select name="comps" id="comps" class="getComps schLine">
					...
					<input type="text" class="AXInput getPyvndNm" style="width : 100px;" name="endcnm" id="endcnm" maxlength="50">
				</div>	
...
<script>
	...
	$.getScript('/js/sal/WAS001FinlCustInfoBase.js');
