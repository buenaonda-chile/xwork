...
$(function(){
	...
	$("#p_start_date, #p_end_date").datepicker({
		closeText          : '<spring:message code="label.eduCalendar1"/>',
        currentText        : '<spring:message code="label.eduCalendar2"/>',
        dateFormat         : 'yy-mm-dd',
        prevText           : '<spring:message code="label.eduCalendar3"/>',
        nextText           : '<spring:message code="label.eduCalendar4"/>',
        monthNames         : ['<spring:message code="label.eduCalendar5"/>','<spring:message code="label.eduCalendar6"/>','<spring:message code="label.eduCalendar7"/>',
        	'<spring:message code="label.eduCalendar8"/>','<spring:message code="label.eduCalendar9"/>','<spring:message code="label.eduCalendar10"/>',
        	'<spring:message code="label.eduCalendar11"/>','<spring:message code="label.eduCalendar12"/>','<spring:message code="label.eduCalendar13"/>',
        	'<spring:message code="label.eduCalendar14"/>','<spring:message code="label.eduCalendar15"/>','<spring:message code="label.eduCalendar16"/>'],
        monthNamesShort    : ['<spring:message code="label.eduCalendar5"/>','<spring:message code="label.eduCalendar6"/>','<spring:message code="label.eduCalendar7"/>',
        	'<spring:message code="label.eduCalendar8"/>','<spring:message code="label.eduCalendar9"/>','<spring:message code="label.eduCalendar10"/>',
        	'<spring:message code="label.eduCalendar11"/>','<spring:message code="label.eduCalendar12"/>','<spring:message code="label.eduCalendar13"/>',
        	'<spring:message code="label.eduCalendar14"/>','<spring:message code="label.eduCalendar15"/>','<spring:message code="label.eduCalendar16"/>'],
        dayNames           : ['<spring:message code="label.eduCalendar17"/>','<spring:message code="label.eduCalendar18"/>','<spring:message code="label.eduCalendar19"/>',
        	'<spring:message code="label.eduCalendar20"/>','<spring:message code="label.eduCalendar21"/>','<spring:message code="label.eduCalendar22"/>','<spring:message code="label.eduCalendar23"/>'],
        dayNamesShort      : ['<spring:message code="label.eduCalendar17"/>','<spring:message code="label.eduCalendar18"/>','<spring:message code="label.eduCalendar19"/>',
        	'<spring:message code="label.eduCalendar20"/>','<spring:message code="label.eduCalendar21"/>','<spring:message code="label.eduCalendar22"/>','<spring:message code="label.eduCalendar23"/>'],
        dayNamesMin        : ['<spring:message code="label.eduCalendar17"/>','<spring:message code="label.eduCalendar18"/>','<spring:message code="label.eduCalendar19"/>',
        	'<spring:message code="label.eduCalendar20"/>','<spring:message code="label.eduCalendar21"/>','<spring:message code="label.eduCalendar22"/>','<spring:message code="label.eduCalendar23"/>'],
...
$(document).ready(function(){
	...
	$('#jqGridList').jqGrid({ 
	    ...
	    colNames : ['SEQ', '<spring:message code="label.edulist6"/>', '<spring:message code="label.edulist7"/>',
	    	'<spring:message code="label.edulist8"/>', '<spring:message code="label.edulist9"/>', '','', '<spring:message code="label.edulist10"/>'],
	    colModel : [
					...
					{name:'reg_user_id',index:'reg_user_id', width:60, sortable:false, align:'center', hidden: true},
					{name:'reg_emp_number',index:'reg_emp_number', width:60, sortable:false, align:'center', hidden: true},
	    ...
	    recordtext: '<spring:message code="label.edulist11"/> {0} - {1}, <spring:message code="label.edulist12"/> {2}',
	    emptyrecords:'<spring:message code="label.edulist13"/>',
	    rowNum : 100, 
		...
		gridComplete : function() {
			...
			for ( var i = 0; i < rows.length; i++ ) {
				...
				var reg_emp_number = $('#jqGridList').getCell( rows[i], "reg_emp_number" );
				

				console.log("1 : " +  reg_emp_number);
				console.log("2 : " + $("#emp_number").val());
				
				if($("#emp_number").val() != reg_emp_number) {
		...
		onCellSelect : function(row_id, iCol) {
			...
			if(row_id != null) {
				...
				if($("#emp_number").val() == item.reg_emp_number) {
        ...
        <div class="doc-wrap" id="docBaseWrap">
            <div class="layout-LW">
                ...
                <div class="left" style="width:923px;">
                    ...
                    <h2 class="subpage-tit"><spring:message code="label.edulist1"/></h2>
                    <div class="search">
                        <div id="btnSearch" >
                        	<a class="button">
                        		<i class="w_search"></i>
                        		<span class="span"><spring:message code="label.edulist2"/></span>
		                 	</a>
                        </div>
                        <div class="center_search_container">
                            <p><spring:message code="label.edulist3"/></p>
                            <input type="text" id="p_subject" name="p_subject" value="" />
                            <p><spring:message code="label.edulist4"/></p>
                    ...
                    <div class="enrollment">
                        <div id="btnReg">
                        	<a class="button">
                        		<i class="w_add"></i>
	                       		<span class="span"><spring:message code="label.edulist5"/></span>
                       		</a>                        		
                        </div>
                    </div>
                </div>
