...
<div class="board-write-wrap">
			...
			<form:form action="${pageContext.request.contextPath}/WAC004BoardCreate/infoCreate.do" modelAttribute="WAC004BoardInfoCreateForm" name="WAC004BoardInfoCreateForm" method="POST">
				...
				<table class="write_01" summary="각 해당하는 항목에 알맞게 내용을 입력해주세요">
					...
					<tbody>
						<tr>
							...
							<td>
								<form:input style="width:150px;" cssClass="form-control input-xs required inlineBlock" type="text" id="boardNm" path="boardNm" maxlength="50" cssErrorClass="form-control input-xs bg_error" required="true" autofocus="true" />
							</td>
						...
						<tr>
							...
							<td>
								<form:input style="width:150px;" cssClass="form-control input-xs required inlineBlock" type="text" id="rowCnt" path="rowCnt" maxlength="5" cssErrorClass="form-control input-xs bg_error" required="true" autofocus="true" />
							</td>
							<th class="check">
								<label for="pageCnt">
									<span class="necessary">* </span>
							...
							<td>
								<form:input style="width:150px;" cssClass="form-control input-xs required inlineBlock" type="text" id="pageCnt" path="pageCnt" maxlength="5" cssErrorClass="form-control input-xs bg_error" required="true" autofocus="true" />
							</td>
						</tr>
						...
						<tr>
							...
							<td colspan="3">
								<form:input style="width:550px;" cssClass="form-control input-xs required inlineBlock" type="text" id="fileExt" path="fileExt" maxlength="200" cssErrorClass="form-control input-xs bg_error" required="true" autofocus="true" value="${fileExt }" /> 세미콜론(;)으로구분
							</td>
						</tr>
					</tbody>
				</table> 
