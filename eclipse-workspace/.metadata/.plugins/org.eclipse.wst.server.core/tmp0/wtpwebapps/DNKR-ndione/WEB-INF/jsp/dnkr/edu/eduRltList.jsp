...
$(document).ready(function(){
	...
	$('#jqGridList').jqGrid({ 
	    ...
	    colNames : ['SEQ', '교육제목', '전체인원','미완료자수','완료자수','교육기간', '등록일', '등록자', '등록자ID', '등록자사번', 'OPER'],
	    colModel : [
					...
					{name:'reg_emp_number',index:'reg_emp_number', width:60, sortable:false, align:'center', hidden: false},
