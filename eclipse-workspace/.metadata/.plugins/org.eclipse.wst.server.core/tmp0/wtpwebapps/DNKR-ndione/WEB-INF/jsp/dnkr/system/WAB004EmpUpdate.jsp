...
$(document.body).ready(function () {
	...
	$('._authConfigBtn_').on( 'click', function(e){
		...
		if(empNumber)
		window.open("/WAD006PrivateAuthConfig/init.do?empNumber="+empNumber+"&authCode="+authCode,"new","width=950,height=700,scrollbars=yes,top=100,left=100");
	});
...
-->							
				...
				>
					...
					<td>
						...
						<form:hidden id="authCode" value="${authCode}" path="authCode" maxlength="45" cssErrorClass="form-control input-xs bg_error"/>
						<form:errors path="authCode" cssStyle="color:#ff0000;" element="span" />
					</td>
				</tr>
				<tr>
