...
$(document).ready(function(){
	...
	$('#jqGridList').jqGrid({ 
	    ...
	    colNames : ['SEQ', '공장', '지역명', '팀명', '사용자', '사원번호', '교육여부', '사용자의견'],
	    colModel : [
					{name:'emp_id',index:'emp_id', width:35, hidden : true},
					...
					{name:'emp_number',index:'emp_number', width:35, sortable:false, align:'center'},
		...
		ondblClickRow: function(row_id, iCol, cellcontent, e) {
			...
			if(row_id != null) {
				...
				if(item.edu_complete == 'O') {
					...
					//window.open("eduRltPopup.do?edu_pk="+edu_pk+"&emp_id="+item.emp_id+"&emp_number="+item.emp_number, "<spring:message code='label.eduDetail17'/>", "width=1100, height=800, left=300, top=50");
					window.open("eduRltPopup.do?edu_pk="+edu_pk+"&emp_number="+item.emp_number, "<spring:message code='label.eduDetail17'/>", "width=1100, height=800, left=300, top=50");
				}
