...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/sal/CustomerPopSelect.js?ver"></script>
<script>
...
<h2 class="subpage-tit"><spring:message code='label.CUST.custSel'/></h2>
<div class="board-bList-wrap select-wrap">
	<div class="k_cg1" style="height : 40px;">
		<div class="gridBtnBlock k_sg1">
			...
			<label class="k_l1"><spring:message code='label.WAN002.pyvnd2'/>코드</label>
			<input type="text" class="AXInput getCusno" style="width : 80px;" name="getCusno" id="getCusno" maxlength="8" 
	...
	<div class="fr">
		<button type="button" class="AXButton Blue _applyBtn_" style=""
			...
			<spring:message code='label.applyEmp' /><!-- ì ì© -->
		</button>
