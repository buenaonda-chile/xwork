   ...
   fileTarget.on('change', function(){ // 값이 변경되면
      ...
      if(window.FileReader){ // modern browser
            ...
            for (var i=0; i<temp.length; i++) {
                ...
                if(file.size > maxSize) alert("첨부파일의 용량이 1GB를 초과할 수 없습니다.");
                else {
                // 파일 업로드 AJAX 통신
                fn_upload(formData);
                }
...
function showPopup2() {
	   window.open("eduPopup2.do", "<spring:message code='label.eduDetail17'/>", "width=1100, height=590, left=300, top=50"); 
	}
...
<input type="hidden" id="p_emp_cd" name="p_emp_cd" value="${emp}" />
<input type="hidden" id="p_emp_name" name="p_emp_name" value="${emp_nm}" />
        ...
        <table class="bWrite">
            <div class="layout-LW">
                ...
                <tbody>
                    ...
                    <tr>
                        <th><spring:message code="label.eduDetail32"/><div class="helper"></div><span class="important">*</span></th>
                        <td>
                    ...
                    <tr>
                        <th><spring:message code="label.eduDetail33"/><div class="helper"></div></th>
                        <td>
                           <input type="button" value="<spring:message code='label.eduDetail28'/>" onclick="showPopup2();" />
                           <!-- 초기화버튼 신규등록일때만 표시 --> 
                            <c:if test="${edu_pk == '' }">
                              <input type="button" value="<spring:message code='label.eduDetail30'/>" onclick="initEmp();" /><br/>
                           </c:if>
                           
                           <div id="p_emp" name="p_emp">${emp_nm }</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                        <input type="text" id="p_time" name="p_time" value="${time}" class="w100" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)'/><spring:message code="label.eduDetail29"/></td>
                    </tr>
                  ...
                  <td><input type="text" id="p_descript" name="p_descript" value="${descript}" class="w100" /></td>
                    ...
                    <tr>
                        ...
                        <input type="file" id="file" name="file"  class="upload-hidden"
                         ...
                         multiple/> <br>※동영상은 업로드시 자동으로 교육 동영상으로 등록됩니다.
                           </div>
                           <ul id="file_list"></ul>
                        </td>
                    </tr>
