...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/dwh/WAE018MaterialInventoryHouse.js"></script>
<!-- [EN] Contents area -->
	...
	<form:form>
		<div class="searchCondition">
			...
			<div class="top-bar cb">				
				...
				<select id="gubun" name="gubun"  onchange="commonClear()">
					<option value="1" selected>자재</option>
					<option value="2">A-PART</option>
				</select>
				<!--
				<%-- 사업부 선택해주세요 --%>
				...
				<select name="house" id="house" onchange="commonClear()">
				...
				<select name="prdcd" id="prdcd" onchange="commonClear()">
				...
				<%-- planner --%>
				<strong class="pr5"><spring:message code='label.planner'/><%-- PLANNER --%></strong>
				<input type="text" name="plann" id="plann" style="width: 200px; padding: 0 20px" maxlength="15"/>
