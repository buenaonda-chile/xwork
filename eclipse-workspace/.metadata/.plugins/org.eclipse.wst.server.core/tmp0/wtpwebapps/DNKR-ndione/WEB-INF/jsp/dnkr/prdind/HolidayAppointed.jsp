...
var LB_DATE = "<spring:message code='label.WAK001.list3'/>";
var LB_REFRN = "<spring:message code='label.WAK001.list13'/>";
var LB_DOTW = "<spring:message code='label.WAK001.list14'/>";
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/prdind/HolidayAppointed.js?ver=1.010"></script>