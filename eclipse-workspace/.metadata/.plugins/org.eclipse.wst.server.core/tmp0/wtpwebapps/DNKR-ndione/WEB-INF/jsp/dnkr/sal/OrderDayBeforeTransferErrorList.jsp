...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/sal/OrderDayBeforeTransferErrorList.js?ver"></script>
...
$(function(){ 
	grid.initView({
		chldt:{label:"<spring:message code='label.WAN012.chldt'/>"},		
						...
						<div class="list-top">
							<div class="fl schLine">
								...
								<div class="dropdown">
									...
									<input type="text" class="dropbtn calendar_input getChldt" name="getChldt" id="getChldt" value="${today}"/>
