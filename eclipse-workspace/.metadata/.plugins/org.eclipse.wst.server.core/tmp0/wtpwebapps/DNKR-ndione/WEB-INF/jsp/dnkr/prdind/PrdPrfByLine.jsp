...
var LB_ITEM = "<spring:message code='label.WAT024.item'/>";
/*
$(function(){
	grid.initView({
...
<div class="grid-block team-ms">
			...
			<div class="k_cg1" style="text-align: center">
				<div class="k_sg1 gridBtnBlock" style="text-align: center">
					...
					<div class="inlineBlock schLine">
						...
						<input type="text" class="AXInput getCusnm" style="width : 60px;" name="getLineId" id="getLineId"  maxlength="8">
					</div>	
 ...
 -->
			...
			<div>
	  			<div class="k_sg4">
					<div class="board-bList-wrap log_board">
						<label class="k_l1">반임율</label>	
						<input type="text" id="halfWRate" style="font-size: 15px;text-align: center;background-color:#C0C0C0" readOnly>	
						<label class="k_l1" style="margin-left: 20px;">기준시간(분)</label>	
						<input type="text" id="stTime" style="font-size: 15px;text-align: center;background-color:#C0C0C0" readOnly>
<!-- 						<input type="text" id="getLgstTm" style="font-size: 15px;text-align: center;" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' onBlur ="changeRgstTime();">

						<button type="button" class="AXButton Normal" style="" onclick="return lgstTmUpdate()">
							<spring:message code="label.save" />
						</button>							
 -->						
						<label class="k_l1" style="margin-left: 20px;">직접생산시간(분)</label>	
						<input type="text" id="dirPrTime"  style="font-size: 15px;text-align: center;background-color:#C0C0C0" readOnly>	
						<label class="k_l1" style="margin-left: 20px;">공수저감지수</label>	
						<input type="text" id="prLowInx" style="font-size: 15px;text-align: center;background-color:#C0C0C0" readOnly>							
						<label class="k_l1" style="margin-left: 20px;">제외간접부서비율</label>	
						<input type="text" id="exIndDepRatio" style="font-size: 15px;text-align: center;background-color:#C0C0C0" readOnly>
						<label class="k_l1" style="margin-left: 20px;">생산성효과금액(원)</label>	
						<input type="text" id="prodEfPrice" style="font-size: 15px;text-align: center;background-color:#C0C0C0" readOnly>
					</div>
				</div>
			</div>
			
			<!--  div class="gridContents" style="position: relative; height: 135px;"-->
			<div class="gridContents" style="position: relative; height: 650px;">
		    	<div id="wijmoGrid1" ></div>									       
		    </div>
		    <!--  div class="gridContents" style="position: relative; height: 660px;">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/prdind/PrdPrfByLine.js?ver=1.724"></script>