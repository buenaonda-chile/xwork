...
var LN_SELECT_PART = "<spring:message code='WAN-I0-0019'/>";
...
<!-- 							
 ...
 -->									
							...
							<div class="inlineBlock schLine">
								...
								<input type="text" class="AXInput getPyvnd" style="width : 60px;" name="getPartId" id="getPartId"  maxlength="8"
...
<script>
	$.getScript('/js/prdind/StEmpAbsSta.js');
</script>
