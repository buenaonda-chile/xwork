...
var LB_EAST_TIME = "<spring:message code='label.WAT006.eastTime'/>";
var LB_EXEN_TIME = "<spring:message code='label.WAT006.exenTime'/>";
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/prdind/WrknTimeBase.js?ver=1.004"></script>