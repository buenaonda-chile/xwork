			...
			<div class="k_cg1" style="text-align: center;">
				<div class="gridBtnBlock k_bg1">
					...
					<div class="inlineBlock">
						<button type="button" class="AXButton Normal" onclick="return update()" style="margin-left: 10px;">
...
<!-- 삭제						
 ...
 -->						
			...
			<div>
	  			<div class="k_sg4">
					<div class="board-bList-wrap log_board">
						<label class="k_l1">근태 총작업시간</label>	
						<input type="text" id="reqWork" style="font-size: 15px;text-align: center;background-color:#C0C0C0" readOnly>	
						<label class="k_l1" style="margin-left: 20px;">근태 물류시간</label>	
						<input type="text" id="ttlLgst" style="font-size: 15px;text-align: center;background-color:#C0C0C0" readOnly>
						<label class="k_l1" style="margin-left: 20px;">투입 물류시간</label>	
...
<!-- 
 ...
 -->						
						<label class="k_l1" style="margin-left: 20px;">판정</label>	
						<input type="text" id="ruling"  style="font-size: 15px;text-align: center;background-color:#C0C0C0" readOnly>	
						<label class="k_l1" style="margin-left: 20px;">물류제외 총작업시간</label>	
						<input type="text" id="ttlWork" style="font-size: 15px;text-align: center;background-color:#C0C0C0" readOnly>							
					</div>
				</div>
			</div>
			...
			<div class="gridContents" style="position: relative; height: 650px;">
		    	...
		    	<a href="javascript:zoomInSf($('#wijmoGrid'),flexGrid);">확대</a>
				<a href="javascript:zoomOutSf($('#wijmoGrid'),flexGrid);">축소</a>					       
		    </div>
		</div>	 	       
	</div>
...
<script>
	$.getScript('/js/prdind/LnPrsInpTm.js');
</script>