...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/sal/CustOrderTypeMstView.js?ver"></script>
...
<script type="text/javascript">
	...
	$(function() {
		grid.initView({
			mcrcd : {
				label : "<spring:message code='label.WAN006.mcrcd'/>"
			},
			seqcd : {
				label : "<spring:message code='label.WAN006.seqcd'/>"
			},
			seqno : {
				label : "<spring:message code='label.WAN006.seqno'/>"
			},
			efffr : {
				label : "<spring:message code='label.WAN006.efffr'/>"
			},
			effto : {
				label : "<spring:message code='label.WAN006.effto'/>"
			},
			pspno : {
			...
			mstsm : {
				label : "<spring:message code='label.WAN006.mstsm'/>"
			},
			cprtn : {
				label : "<spring:message code='label.WAN000.cprtn'/>"
			},
		}).setData();
	});
				...
				<div class="gridBtnBlock k_sg1">
					...
					<div class="inlineBlock">
						<input type="text" class="AXInput getMcrcd" style="width: 180px;"
							name="getMcrcd" id="getMcrcd" maxlength="3" onBlur="getCarSch();"
							placeholder="<spring:message code='WAN-I0-0009'/>"
							title="<spring:message code='WAN-I0-0009'/>">
