...
var LB_WORK_DIV = "<spring:message code='label.WAT006.workDiv'/>";
var LB_GROUP = "<spring:message code='label.WAT006.group'/>";
var LB_START_TIME = "<spring:message code='label.WAT005.startTime'/>";
var LB_END_TIME = "<spring:message code='label.WAT005.endTime'/>";
var LB_APPLY_START_DE = "<spring:message code='label.WAT006.applyStartDe'/>";
var LB_APPLY_END_DE = "<spring:message code='label.WAT006.applyEndDe'/>";
var LB_REFRN = "<spring:message code='label.WAT002.refrn'/>";
...
var LB_WRKN_RCRN = "<spring:message code='label.WAT026.wrknRcrn'/>";
var LB_WRKN_RCRN_ORDER = "<spring:message code='label.WAT026.wrknRcrnOrder'/>";
var LB_WRKN_WEEK_INTR = "<spring:message code='label.WAT026.wrknWeekIntr'/>";
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/prdind/WrknRcRn.js?ver=1.007"></script>