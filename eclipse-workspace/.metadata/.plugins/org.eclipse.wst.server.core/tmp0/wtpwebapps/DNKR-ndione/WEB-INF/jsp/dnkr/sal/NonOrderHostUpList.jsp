...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/sal/NonOrderHostUpList.js?ver=1.1"></script>
...
var lackcntLabel = "<spring:message code='label.WAN016.lackcnt'/>";
var stockaLabel = "<spring:message code='label.WAN016.stocka'/>";
var stockbLabel = "<spring:message code='label.WAN016.stockb'/>";
var stockcLabel = "<spring:message code='label.WAN016.stockc'/>";
var stocka2Label = "<spring:message code='label.WAN016.stocka2'/>";
var stockb2Label = "<spring:message code='label.WAN016.stockb2'/>";
var stockc2Label = "<spring:message code='label.WAN016.stockc2'/>";
var stocka3Label = "<spring:message code='label.WAN016.stocka3'/>";
var stockb3Label = "<spring:message code='label.WAN016.stockb3'/>";
var stockc3Label = "<spring:message code='label.WAN016.stockc3'/>";
var stocka4Label = "<spring:message code='label.WAN016.stocka4'/>";
var stockb4Label = "<spring:message code='label.WAN016.stockb4'/>";
var stockc4Label = "<spring:message code='label.WAN016.stockc4'/>";
